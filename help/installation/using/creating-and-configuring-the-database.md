...
uuid: 004186c7-78e7-43b7-a783-2dd32675a90b
contentOwner: sauviat
products: SG_CAMPAIGN/CLASSIC
content-type: reference
discoiquuid: 948c29b8-7191-4b88-a510-5f65ef741bde
index: y
internal: n
snippet: y
---
...
>Only the **internal** identifier can carry out these operations. For more on this, refer to [Internal identifier](../../installation/using/creating-and-configuring-the-database.md#internal-identifier).
...
* For a **Microsoft SQL Server** engine, you must define:
    ...
    1. the authentication method used to access Microsoft SQL Server: **SQL Server authentication** or **Windows NT authentication**.
...
* For an Oracle, Microsoft SQL Server or PostgreSQL database, the administrator may also define the **storage parameters** to be used when creating database objects.
  ...
  These parameters receive the exact tablespace names (warning: case sensitive). They are respectively stored in the **Administration > Platform > Options** node in the following options:
...
You must now start the deployment wizard to finish configuring the instance. Refer to [Deployment wizard](../../installation/using/creating-and-configuring-the-database.md#deployment-wizard).
...
* For a **Microsoft SQL Server** engine, you must define:
    ...
    1. the security method used to access Microsoft SQL Server: **SQL Server authentication** or **Windows NT authentication**.
