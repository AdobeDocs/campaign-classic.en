...
uuid: adf92575-2bce-4212-883e-e94a8e93d178
contentOwner: sauviat
products: SG_CAMPAIGN/CLASSIC
content-type: reference
discoiquuid: 66c3c024-2b85-4011-8a71-36cc18a2a590
index: y
internal: n
snippet: y
---
...
* Install Oracle Java or OpenJDK (for more on this, refer to [Java Development Kit - JDK](../../installation/using/installing-packages-with-linux.md#java-development-kit---jdk)):

  ```
  ./jdk-6uxx-linux-x64-rpm.bin
  ```

* Install OpenSSL 1.0 (for more on this, refer to [Libraries](../../installation/using/installing-packages-with-linux.md#libraries)):
...
* Install libicu 4.2 (for more on this, refer to [Libraries](../../installation/using/installing-packages-with-linux.md#libraries)):
...
See section [Internal identifier](../../installation/using/installing-packages-with-linux.md#internal-identifier).
