...
uuid: 016a1ab9-1881-40d9-ac10-e2461c459958
contentOwner: sauviat
products: SG_CAMPAIGN/CLASSIC
content-type: reference
discoiquuid: 2333b217-5a06-418c-91cf-00fc0ce5aefa
index: y
internal: n
snippet: y
---
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> Authorized files to be downloaded separated by ','. The string must be a valid, regular java expression. See <a href="../../installation/using/the-server-configuration-file.md#limiting-uploadable-files" target="_blank">Limiting uploadable files</a>.<br /> </td> 
   <td> String<br /> </td> 
   <td> '.+' <br /> </td> 
  </tr> 
  <tr> 
...
For additional information, refer to [Managing public resources](../../installation/using/the-server-configuration-file.md#managing-public-resources).
...
For additional information, refer to [Restricting authorized external commands](../../installation/using/the-server-configuration-file.md#restricting-authorized-external-commands).
...
For additional information, refer to [Proxy connection configuration](../../installation/using/the-server-configuration-file.md#proxy-connection-configuration).
...
For additional information, refer to [Outgoing connection protection](../../installation/using/the-server-configuration-file.md#outgoing-connection-protection).
...
For additional information, refer to [Activating email archiving (on premise)](../../installation/using/the-server-configuration-file.md#activating-email-archiving--on-premise-).
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> Time of the day when the process is automatically restarted. See <a href="../../installation/using/the-server-configuration-file.md#automatic-process-restart" target="_blank">Automatic process restart</a>.<br /> </td> 
   <td> String<br /> </td> 
   <td> '06:00:00' <br /> </td> 
  </tr> 
  <tr> 
...
For additional information, refer to [SMTP relay](../../installation/using/the-server-configuration-file.md#smtp-relay).
...
For additional information, refer to [Email sending optimization](../../installation/using/the-server-configuration-file.md#email-sending-optimization).
...
For additional information, refer to [List of IP addresses to use](../../installation/using/the-server-configuration-file.md#list-of-ip-addresses-to-use) and [Managing outbound SMTP traffic with affinities](../../installation/using/the-server-configuration-file.md#managing-outbound-smtp-traffic-with-affinities).
...
For additional information, refer to [List of IP addresses to use](../../installation/using/the-server-configuration-file.md#list-of-ip-addresses-to-use).
...
For additional information, refer to [Defining security zones](../../installation/using/the-server-configuration-file.md#defining-security-zones).
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> Tomcat listening control port: refer to <a href="../../installation/using/the-server-configuration-file.md#configuring-tomcat" target="_blank">Configuring Tomcat</a>.<br /> </td> 
   <td> Short<br /> </td> 
   <td> 8005<br /> </td> 
  </tr> 
  <tr> 
   <td> httpPort<br /> </td> 
   <td> Tomcat HTTP listening port: refer to <a href="../../installation/using/the-server-configuration-file.md#configuring-tomcat" target="_blank">Configuring Tomcat</a>.<br /> </td> 
   <td> Short<br /> </td> 
   <td> 8080<br /> </td> 
  </tr> 
  <tr> 
...
For additional information, refer to [Dynamic page security and relays](../../installation/using/the-server-configuration-file.md#dynamic-page-security-and-relays) and [section](../../installation/using/deploying-an-instance.md#synchronizing-public-resources).
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   <td> targetUrl<br /> </td> 
   <td> URL of the target page: refer to <a href="../../installation/using/the-server-configuration-file.md#configuring-tomcat" target="_blank">Configuring Tomcat</a>.<br /> </td> 
   <td> String<br /> </td> 
   <td> <br /> </td> 
  </tr> 
  <tr> 
...
For additional information, refer to [Managing HTTP headers](../../installation/using/the-server-configuration-file.md#managing-http-headers).
...
For additional information, refer to [Redundant tracking](../../installation/using/the-server-configuration-file.md#redundant-tracking). 
...
For additional information, refer to [High availability workflows and affinities](../../installation/using/the-server-configuration-file.md#high-availability-workflows-and-affinities).
