...
uuid: 71714133-f80c-4ee9-9b3a-628644028c08
contentOwner: sauviat
products: SG_CAMPAIGN/CLASSIC
content-type: reference
discoiquuid: 0b66bd0b-e947-45e2-8934-45b0e4fba447
index: y
internal: n
snippet: y
---
...
The rules to be complied with for MX are defined in the **MX management** document of the **Campaign execution > Administration > Non deliverables Management > Mail rule sets** document of the tree.
...
1. Choose the **MX management** mode.

   ![](assets/s_ncs_install_mx_mgt_rule.png)

1. Enter **defaultMXRules** in the **Internal name** field.
...
* **Shared**: this option indicates that the highest number of messages per hour and the number of connections apply to all MXs linked to this rule. 
...
* **Connection time out**: time threshold for connecting to an MX.
