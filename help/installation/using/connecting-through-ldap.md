...
uuid: 38f9cc7b-6dac-48e8-a831-b8e4640ae9b7
contentOwner: sauviat
products: SG_CAMPAIGN/CLASSIC
content-type: reference
discoiquuid: ccbe09f8-b4ca-440e-8cdb-7bef53b77af0
index: y
internal: n
snippet: y
---
...
The LDAP configuration is carried out in the deployment wizard. The **LDAP integration** option must be selected during the first configuration step. Refer to [Deployment wizard](../../installation/using/connecting-through-ldap.md#deployment-wizard).
...
* Select the user authentication mode: **Automatically compute the unique user identifier** (see step [Distinguished Name calculation](../../installation/using/connecting-through-ldap.md#distinguished-name-calculation)) or **Search the unique user identifier in the directory** (see step [Searching for identifiers](../../installation/using/connecting-through-ldap.md#searching-for-identifiers)).
...
* Specify the **Base identifier** and **Search scope** fields in order to determine a subset of the LDAP directory to start the search from.
  ...
  ![](assets/s_ncs_install_deployment_wiz_ldap_03.png)
    ...
    1. **Limited to the base**.

       All attributes are included in the search.
    
    1. **Limited to the first sub-level of the base**.
...
This window is displayed when you select the **Enable synchronization of user rights from authorizations and groups in the directory** option (refer to [](../../installation/using/connecting-through-ldap.md)).
