...
uuid: ae4197e5-5ae4-4216-be70-d0ac5f405be9
contentOwner: sauviat
products: SG_CAMPAIGN/CLASSIC
content-type: reference
discoiquuid: 1849f808-e9a9-4643-a674-89b4e23fcaa2
index: y
internal: n
snippet: y
---
...
* Java JDK and OpenJDK, refer to [Java Development Kit - JDK](../../installation/using/prerequisites-of-campaign-installation-in-linux.md#java-development-kit---jdk),
...
>[!NOTE]
>
>If you have already installed the Oracle client but the global environment (for instance: /etc/profile) isn't properly configured, you can add missing information to the **nl6/customer.sh** script For more on this, refer to [Environment variables](../../installation/using/prerequisites-of-campaign-installation-in-linux.md#environment-variables).
