...
uuid: bbb5f90b-30fa-445c-a490-2c3758e1bf54
contentOwner: sauviat
products: SG_CAMPAIGN/CLASSIC
content-type: reference
discoiquuid: aa38789f-ce26-4d7f-a46d-1ac0d244d5cd
index: y
internal: n
snippet: y
---
...
1. Select the installation type.
    ...
    * **Minimal installation (Network)**: Installation of the client computer from the network. Only a limited number of DLLs will be installed on the computer, if necessary, and all the other components will be used from a network drive.
    * **Installation of a client**: Installation of the required components for the Adobe Campaign client.
    * **Custom installation**: The user chooses the elements to be installed.
...
1. Click **Finish** to start the installation:
...
See section [Internal identifier](../../installation/using/installing-the-server.md#internal-identifier).
