...
uuid: 23595c4a-438e-4993-97b0-a8a5123f5ff6
contentOwner: sauviat
products: SG_CAMPAIGN/CLASSIC
content-type: reference
discoiquuid: 70713ab5-1caf-4654-8238-ecf7c6adcb1f
index: y
internal: n
snippet: y
---
...
* Once email BCC is configured, make sure the feature is enabled in the delivery template or in the delivery through the **Archive emails** option. For more on this, see [this section](../../delivery/using/sending-messages.md#archiving-emails).
...
The archive file name is ** `<deliveryid>  -  <broadlogid>   .eml  </broadlogid> </deliveryid>`** when the status of the emails is not **Sent**. Once the status has changed to **Sent**, the file name becomes ** `<deliveryid>  -  <broadlogid>   -sent.eml  </broadlogid> </deliveryid>`**. For example:
...
>Besides, the relay assigns a **Sent** status to all emails, including those that are not sent. Therefore, all messages are archived.
...
Once email BCC is configured, make sure you select the **Archive emails** option in the delivery template or the delivery. For more on this, see [this section](../../delivery/using/sending-messages.md#archiving-emails).
