...
uuid: 939499d2-123f-4fc7-848a-19c6dd14bdac
contentOwner: sauviat
products: SG_CAMPAIGN/CLASSIC
content-type: reference
discoiquuid: c8a82e6a-104e-4664-8df6-16bb92fb6f2f
index: y
internal: n
snippet: y
---
...
Operators are linked to a security zone from its profile in the console (**Administration > Access management > Operators** node). Learn how to link zones to Campaign operators in [this section](../../installation/using/configuring-campaign-server.md#linking-a-security-zone-to-an-operator).
...
Prior to this, you must start by configuring the out-of-the-box **Security zone** enumeration to link a label to the internal name of the zone defined in the **serverConf.xml** file.

This configuration is done in the Campaign explorer:

1. Click the **Administration > Platform > Enumerations** node.
1. Select the **Security zone (securityZone)** system enumeration.

   ![](assets/enum_securityzone.png)

1. For each security zone defined in the configuration file of the server, click the **Add** button. 
1. In the **Internal name** field, enter the name of the zone defined in the **serverConf.xml** file. It corresponds to the **@name** attribute of the `<securityzone>  element. Enter the label linked to the internal name in the  <strong>Label</strong> field. </securityzone>`

   ![](assets/enum_addsecurityvalue.png)

1. Click OK and save the modifications.

Once the zones are defined and the **Security zone** enumeration is configured, you need to link each operator to a security zone:

1. Click the **Administration > Access management > Operators** node.
1. Select the operator whom you want to link a security zone to, and click the **Edit** tab.
1. Go to the **Access rights** tab and click the **Edit access parameters...** link.

   ![](assets/zone_operator.png)

1. Select a zone from the **Authorized connection zone** drop-down list

   ![](assets/zone_operator_selection.png)

1. Click **OK** and save the modifications to apply these changes.
...
Also refer to [Email sending optimization](../../installation/using/configuring-campaign-server.md#email-sending-optimization).
...
1. To enable affinity selection in the drop-down lists, you need to add the affinity name(s) in the **IPAffinity** enumeration.
   ...
   >[!NOTE]
   >
   >You can also refer to [Delivery server configuration](../../installation/using/configuring-campaign-server.md#delivery-server-configuration).
...
Public resources are presented in [Managing public resources](../../installation/using/configuring-campaign-server.md#managing-public-resources).
...
1. Modify the line which matches the **wfserver** module as follows:
