...
The page below details server-side configurations that can be performed to match your needs and your environment specificities, such as:

* Tomcat configuration [here](#configuring-tomcat)
* Delivery parameters customization [here](#personalizing-delivery-parameters)
* URL permissions [here](#url-permissions)
...
* Uploaded files limitations [here](#limiting-uploadable-files)
* Proxy connection settings [here](#proxy-connection-configuration)
* Campaign Interaction module data buffer [here](#interaction-data-buffer)

See also [these pages](#related-topics)
...
* [Campaign On-premise & Hosted capability matrix](../../installation/using/capability-matrix.md)