...
uuid: 02ad988c-f325-44d5-9afb-23a56a77e177
contentOwner: sauviat
products: SG_CAMPAIGN/CLASSIC
content-type: reference
discoiquuid: a9260a87-0675-4c0a-a2bb-f3260f2f57f9
index: y
internal: n
snippet: y
---
...
1. Download the **Spam Assassin (Windows Installation) (1.0)** file.
...
1. Change the value of the **spamCheck** elements' **command** attribute in the **Web** node. To do this, run the following command:
   ...
   Stop and start the **Adobe Campaign** service.
