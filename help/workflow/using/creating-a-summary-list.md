...
uuid: c8d9fd95-5d3f-42f7-a8b3-a2eb59adf734
contentOwner: sauviat
products: SG_CAMPAIGN/CLASSIC
content-type: reference
discoiquuid: fa0c30df-09e0-40b8-873a-252fd0f3431e
index: y
internal: n
snippet: y
---
...
1. Add the **File collector** and **Data loading (file)** activities to the workflow.
   ...
   For more on this activity, refer to [Loading data from a file](../../workflow/using/creating-a-summary-list.md#loading-data-from-a-file).
...
1. Click **Add data**, then select the **A link** option.

   ![](assets/uc2_enrich_enrich2.png)

1. Select the **Define a collection** option.
1. Select the "Stores" schema as a target.

   ![](assets/uc2_enrich_enrich3.png)

For more on the various types of links, refer to [Enriching and modifying data](../../workflow/using/creating-a-summary-list.md#enriching-and-modifying-data).
...
1. Add the "ZipCode Reference" field to the **Output columns**.
...
1. Check the **Keep unreconciled data coming from the work table ** option.
...
1. Select the **By directly using the targeting dimension** value for the **Record identification** option.
1. Select the "Purchases" schema as a **Document type**.
1. Specify the list of fields to be updated. The **Destination** column lets you define the fields of the "Purchases" schema. The **Expression** column lets you select the fields in the work table to carry out a mapping.
1. Click the **Generate an outbound transition** option.
...
1. Click add **Data**.
1. Click the **Data linked to the targeting dimension** option.
1. Click the **Data linked to the filtering dimension** option in the **Select fields to add** window.
1. Select the **Purchases** node then click **Next**.

   ![](assets/uc2_enrich_enrich9.png)

1. Change the **Collected data** field by selecting the **Aggregates** option.
...
1. Click the **Edit additional data...** link in the enrichment activity.
...
1. Select the **Create the list if necessary (Calculated name)** option.
