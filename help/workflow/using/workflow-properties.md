...
* **[!UICONTROL Default affinity]**
  ...
  Refer to this [section](https://helpx.adobe.com/campaign/classic/installation/using/configuring-campaign-server.html#high-availability-workflows-and-affinities).
