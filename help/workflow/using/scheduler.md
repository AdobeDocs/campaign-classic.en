...
* Never use more than one **[!UICONTROL Scheduler]** activity per branch in a workflow. See [Use activities](../../workflow/using/workflow-best-practices.md#using-activities).
...
## Configure the Scheduler activity {#configuring-scheduler-activity}
