...
uuid: 57db2473-4dd7-44f7-af0a-adcb227bd312
contentOwner: sauviat
topic-tags: targeting-activities
products: SG_CAMPAIGN/CLASSIC
content-type: reference
discoiquuid: d1c7cdda-d467-4dd2-9b28-6f09a8dc425f
index: y
internal: n
snippet: y
---
...
1. Go to the **Remote fields** section and enter the fields to be imported.
   ...
   If necessary, alter the data format via the drop-down list of the **Conversion** columns. Possible conversion types are detailed in this [page](/platform/using/crm-connectors.md#data-format).
...
* Comparisons may only concern null values ('is empty'/'is not empty' type) or numbers. This means that once the **Value** column (right-hand column) is assessed, the result of this assessment must be a number.
* The data in the **Value** column is assessed in JavaScript.
...
1. In the **Mapping** section, specify the fields to be exported and their mapping in the CRM.
   ...
   If necessary, alter the data format via the drop-down list of the **Conversion** columns. Possible conversion types are detailed in this [section](/platform/using/crm-connectors.md#data-format).
...
The **Reject** outbound transition lets you access the output schema that contains the specific columns relevant to error messages and codes. These columns are:
...
The **Behavior** tab lets you enable the processing of rejects. This option generates a second output transition for the **CRM connector** activity. For more on this, refer to this [section](/platform/using/crm-connectors.md#error-processing).
