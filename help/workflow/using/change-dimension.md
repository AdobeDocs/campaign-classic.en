...
1. The **[!UICONTROL Result]** tab lets you add additional information.
    ...
    * Click the **[!UICONTROL Add data...]** link and select **[!UICONTROL Data linked to the filtering dimension]** .
      ...
      >[!NOTE]
      >
      >For information on creating and managing additional columns, refer to [Adding data](https://helpx.adobe.com/campaign/standard/workflow/using/query.html#adding-data).
