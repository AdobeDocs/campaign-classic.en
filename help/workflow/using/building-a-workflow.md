...
uuid: 52318237-af9b-460d-87e5-8c2fa95ae1d6
contentOwner: sauviat
products: SG_CAMPAIGN/CLASSIC
content-type: reference
discoiquuid: fa6c3ad0-978d-4607-8085-075bd462c6df
index: y
internal: n
snippet: y
---
...
* The first tab contains targeting and data manipulation activities. These activities are detailed in [Targeting activities](../../workflow/using/building-a-workflow.md#targeting-activities).
* The second tab contains the scheduling activities, which are mainly used for coordinating other activities. These activities are detailed in [Flow control activities](../../workflow/using/building-a-workflow.md#flow-control-activities).
* The third tab contains tools and actions that can be used in the workflow. These activities are detailed in [Action activities](../../workflow/using/building-a-workflow.md#action-activities).
* The fourth tab contains activities that depend on a given event, such as the receipt of an email or the arrival of a file on a server. These activities are detailed in [Event activities](../../workflow/using/building-a-workflow.md#event-activities).
...
* **Object alignment**
  ...
  To align icons, select them and click the **Align vertically** or **Align horizontally** icon.
...
In addition to these activities, Data Management options let you manipulate data and access advanced functions to satisfy complex targeting issues. For more on this, refer to [Data Management](../../workflow/using/building-a-workflow.md#data-management).
...
1. For identifying data in the database, refer to [Creating queries](../../workflow/using/building-a-workflow.md#creating-queries).
1. For preparing data to meet delivery needs, refer to [Enriching and modifying data](../../workflow/using/building-a-workflow.md#enriching-and-modifying-data).
1. For using data to perform updates or within a delivery, refer to [Updating the database](../../workflow/using/building-a-workflow.md#updating-the-database).

The results of all enrichments and all handlings carried out during targeting are stored and accessible in personalization fields, in particular for use when creating personalized messages. For more on this, refer to [Target data](../../workflow/using/building-a-workflow.md#target-data)
