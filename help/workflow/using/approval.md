...
uuid: a73206e3-9fc3-4ba1-8bb0-0cd99094cbd9
contentOwner: sauviat
products: SG_CAMPAIGN/CLASSIC
content-type: reference
discoiquuid: 02df1d5b-15fd-4b1c-acd1-9971964e5ad1
index: y
internal: n
snippet: y
---
...
This **Title** field contains the title of the message: This is the subject of the email message sent. The title, as well as the message body, are JavaScript templates and can therefore contain values calculated according to the context of the workflow.
...
An approval example is shown in [Defining approvals](../../workflow/using/approval.md#defining-approvals).
