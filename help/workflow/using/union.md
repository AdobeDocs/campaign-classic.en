...
>[!NOTE]
>
>For more on configuring and using the union activity, refer to [Combining several targets (Union)](https://helpx.adobe.com/campaign/standard/workflow/using/targeting-data.html#combining-several-targets--union-).
...
1. Approve the union activity then configure the list update activity (see [List update](https://helpx.adobe.com/campaign/standard/workflow/using/list-update.html)). 
