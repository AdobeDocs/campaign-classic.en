...
uuid: 6cc82dca-3c86-477c-bf9a-f82eb6bed3a9
contentOwner: sauviat
products: SG_CAMPAIGN/CLASSIC
audience: interaction
content-type: reference
discoiquuid: 130f4a0e-a862-41ac-a8ea-825d836bdde7
index: y
internal: n
snippet: y
---
...
1. Creating an offer environment by targeting dimension. For more on this, refer to [Creating an offer environment](../../interaction/using/implementation-steps.md#creating-an-offer-environment).
1. Creating typology rules for each environment. For more on this, refer to [Creating and referencing an offer presentation rule](../../interaction/using/implementation-steps.md#creating-and-referencing-an-offer-presentation-rule).
