...
uuid: 40f249ed-1d2e-4d73-94e5-9b0713b8e89a
contentOwner: sauviat
products: SG_CAMPAIGN/CLASSIC
audience: interaction
content-type: reference
discoiquuid: 916a64a9-3250-4838-8edc-f884ed7c1e98
index: y
internal: n
snippet: y
---
...
1. Then configure a delivery activity that corresponds to your chosen channel. For more on this, refer to the [Inserting an offer proposition into a delivery](../../interaction/using/integrating-an-offer-via-a-workflow.md#inserting-an-offer-proposition-into-a-delivery) section.
...
>[!NOTE]
>
>Remember: The **Offer engine** activity does store this information by default.
