...
uuid: 8fd9c9ed-1bd7-4a96-97ba-478e58927662
contentOwner: sauviat
products: SG_CAMPAIGN/CLASSIC
audience: interaction
content-type: reference
discoiquuid: 39f0a815-9938-4210-9444-a56a1c961290
index: y
internal: n
snippet: y
---
...
1. Go to the **Campaigns** universe and click the **Offers** link.
...
1. Click **Save** to create the offer.
...
In the **Eligibility** tab, define the period the offer will be valid for and can be presented, the filters to apply to the target and the offer weight.
...
To do this, click the **Edit query** link and select the filter you want to apply. (Refer to [this section](../../platform/using/steps-to-create-a-query.md#step-4---filter-data)). 
...
To view it, click the **Schedule and eligibility rules** link.

![](assets/offer_eligibility_create_005.png)

## Creating the offer content {#creating-the-offer-content}

1. Click the **Edit** tab, then click the **Content** tab.

   ![](assets/offer_content_create_001.png)

1. Complete the various fields of the offer content.

    * **Title**: Specify the title that you would like to make appear in your offer. Warning: this is not referring to the offer's label, which is defined in the **General** tab.
    * **Destination URL**: specify your offer's URL. To be processed correctly, it must start with "http://" or "https://".
    * **Image URL**: specify a URL or an access path to the image of your offer.
    * **HTML content** / **Text content**: enter the body of your offer in the tab you would like.

      To generate tracking, the **HTML content** must be composed of HTML elements that can be enclosed in a 
   ...
   Defining the acceptance URL is presented in the [Configuring the status when the proposition is accepted](../../interaction/using/creating-an-offer.md#configuring-the-status-when-the-proposition-is-accepted) section.

   ![](assets/offer_content_create_002.png)

   To find the required fields as they were defined during offer space configuration, click the **Content definitions** link to display the list. For more on this, refer to [Creating offer spaces](../../interaction/using/creating-offer-spaces.md).
...
Hypotheses carried out on an offer proposition are referenced in their **Measure** tab.
