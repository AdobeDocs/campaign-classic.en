...
uuid: f35495a2-4a06-40f6-9e2f-467346beaab6
contentOwner: sauviat
products: SG_CAMPAIGN/CLASSIC
audience: interaction
content-type: reference
discoiquuid: 84a8f941-3664-45a2-a8f8-c4ace5e6b517
index: y
internal: n
snippet: y
---
...
If you have personalized an offer using additional data, this data will not appear in the preview by default because it is not available in the database. In the environment's **Example of call data** tab, you must add value samples to use in the preview. Please respect the same xml structure that is in the **nms:interaction** schema extension. For more on this, refer to [Additional data configuration](../../interaction/using/additional-data.md#additional-data-configuration).
