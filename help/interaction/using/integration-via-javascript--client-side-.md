...
uuid: d15575b4-4607-4d70-b7e4-fb49447ab933
contentOwner: sauviat
products: SG_CAMPAIGN/CLASSIC
audience: interaction
content-type: reference
discoiquuid: 0b0bf9bf-ce5f-48b6-b3ef-0f665a371ba1
index: y
internal: n
snippet: y
---
...
1. Select **Overload the HTML rendering function**.
1. Go to the **HTML rendering** tab and insert the variables that match the fields defined for the offer content in the offer space.
...
1. Go to the offer space and click the **Edit functions** link.
1. Select **Overload the XML rendering function**. 
1. Go to the **XML rendering** tab and insert the desired function.
