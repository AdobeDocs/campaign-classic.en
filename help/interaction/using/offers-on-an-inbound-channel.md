...
uuid: cd817be4-28c6-4426-82cb-a33f773c38c5
contentOwner: sauviat
products: SG_CAMPAIGN/CLASSIC
audience: interaction
content-type: reference
discoiquuid: 8ed649ca-fb1a-4df5-9c8b-66acc4df5ef7
index: y
internal: n
snippet: y
---
...
Follow the procedure detailed in [Creating an offer environment](../../interaction/using/offers-on-an-inbound-channel.md#creating-an-offer-environment) to create your anonymous environment based on the **Visitors**' dimensions.
...
1. In your anonymous environment (**Visitors**) go to the **Administration** > **Spaces** node.
1. Click **New** to create call channels.
...
1. Change the label and select the **Inbound Web** channel. You also have to check the **Enable unitary mode** box.
...
1. Go to the **Offer catalog** node within the environment you have just created.
1. Right-click the **Offer catalog** node and select **Create a new 'Offer category' folder**.

   Name the new category, **Financial products** for example.

1. Go to the category's **Eligibility** tab and enter **financing** as a theme, then save changes.
...
1. Go to the **Eligibility** tab and specify the weight of the offers according to its application contexts.
...
1. Go to the **Content** tab and define the content of the offer.

   >[!NOTE]
   >
   >You can select **Content definitions** to display the list of elements required for the web space.
...
1. Go to the **Eligibility** tab and apply the same weight as for the first offer.
...
1. Create an offer environment for anonymous inbound interactions via the delivery mapping wizard (**Visitor** mapping). For more on this, refer to [Creating an offer environment](../../interaction/using/offers-on-an-inbound-channel.md#creating-an-offer-environment).
...
1. Create a new **Inbound web** type space.
...
1. Go to the **Offer catalog** in the anonymous environment that you have just created.
1. Add an **Offer category** folder with **Best Offer** as a label.
...
1. Go to the **Eligibility** tab and apply the same weight that you applied to the first offer in this category so that the offers are displayed successively on the website.
...
1. Select the **Fall back on an anonymous environment if no individuals were identified** option.
...
1. Select the **Best Offer** offer space and click **Advanced parameters**.

   ![](assets/offer_inbound_fallback_example_044.png)

1. In the **Target identification** tab, click **Add**.

   ![](assets/offer_inbound_fallback_example_046.png)

1. Click **Edit expression**, go to the recipients table and select the **Email** field.

   ![](assets/offer_inbound_fallback_example_047.png)

1. Click **OK** to close the **Advanced parameters** window and finish configuring the **Best Offer** offer space.
...
1. Go to the **Offer catalogs** node in the identified environment.
1. As in the anonymous environment, add two **Offer category** folders with **Best Offer** and **Partner** as a labels.
