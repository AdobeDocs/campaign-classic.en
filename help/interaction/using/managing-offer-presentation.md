...
uuid: 258858ea-774f-47f9-93be-01f2234c9c7f
contentOwner: sauviat
products: SG_CAMPAIGN/CLASSIC
audience: interaction
content-type: reference
discoiquuid: 8903f181-06c5-40f2-82e2-d4262ee43886
index: y
internal: n
snippet: y
---
...
1. Go to the **Administration** > **Campaign management** > **Typology management** > **Typology rules** node. 
1. Create a typology rule and choose the **Offer presentation** type.
...
1. Go to the **Administration** > **Campaign execution** > **Typology management** >**Typologies** node and create a typology that will group all **Offer presentation** type rules.
...
1. In your typology rule, click the **Edit the rule application conditions...** link to create your query.
...
These criteria represent the most frequent applications of presentation rules. To use other criteria, you can create a query using the **Limit propositions...** link. For more on this, refer to the [Creating a query on propositions](../../interaction/using/managing-offer-presentation.md#creating-a-query-on-propositions) section.
