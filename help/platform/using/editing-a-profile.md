...
uuid: 262e2ccd-0358-430e-b2a4-4fc8dba5ef31
contentOwner: sauviat
products: SG_CAMPAIGN/CLASSIC
audience: platform
content-type: reference
topic-tags: profile-management
discoiquuid: e6f498cc-a97c-4ef3-96d7-46c0e384b1e8
index: y
internal: n
snippet: y
---
...
>[!CAUTION]
>
>The XML schema and the form that concerns the fields in the profiles table are accessed via the **Administration > Configuration > Data schemas** node of the Adobe Campaign tree. Only expert users may make changes to these schemas.  
