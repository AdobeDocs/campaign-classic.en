...
If you are running on [Campaign [!DNL Gold Standard] version](../../rn/using/gold-standard.md), you also need to share the SHA/1 characters which are displayed in the **[!UICONTROL About]** box. For example, for the **Gold Standard 12** release, this build number may be displayed: "build 9032&#64;554dbcd".
