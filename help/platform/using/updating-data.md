...
There are two types of updates: mass update for a set of recipients, and data merging between two profiles. For each action, an assistant lets you configure the update.

### Mass update {#mass-update}

For mass updating, use **[!UICONTROL Action > Mass update of selected lines...]**. The assistant helps you configure and run the update.

The first step of the assistant is to specify the field(s) to be updated.

The left-hand section of the assistant displays the list of available fields. Use the **[!UICONTROL Find]** field to run a search of these fields. Press the **Enter** key to browse the list. The field names matching your entry appear in bold, as shown below.

Double-click the field(s) to be updated to display them in the right-hand section of the assistant.
...
Close this window and click **[!UICONTROL Next]** to display the second update assistant step. In this step, you can launch the update by clicking **[!UICONTROL Start]**.

![](assets/s_ncs_user_update_wizard01_4.png)

Information concerning update execution is displayed in the upper section of the assistant.
...
1. Then select the data to extract. By default, all columns displayed are added to the output columns.
   ...
   For more on how to configure the export assistant, refer to [this section](../../platform/using/executing-export-jobs.md).
