...
The Adobe Campaign explorer is accessible via the toolbar icon. It lets you access all the Adobe Campaign capabilities, configuration screens and a more detailed view of some of the platform elements.
...
Learn how to **access, design and share filters** in the [Campaign v8 (console) documentation](https://experienceleague.adobe.com/en/docs/campaign/campaign-v8/audience/create-filters){target=_blank}.

### Query the database{#about-queries-in-campaign}
...
+++About the generic query editor
...
### Manage lists {#manage-and-customize-lists}
