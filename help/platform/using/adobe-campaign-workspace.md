...
### Navigation hierarchy{#about-navigation-hierarchy}
...
Learn how to configure Campaign explorer hierarchy [in this section](../../configuration/using/configuration.md)
