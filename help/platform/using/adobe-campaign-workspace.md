...
uuid: e01f83a9-eb09-4765-9882-2f25cf24699d
contentOwner: sauviat
products: SG_CAMPAIGN/CLASSIC
audience: platform
content-type: reference
topic-tags: starting-with-adobe-campaign
discoiquuid: f82ef8be-fd4c-432b-b442-d61d9ffe3f48
index: y
internal: n
snippet: y
---
...
To load (and therefore display) additional records (200 lines by default) click **Continue loading**.
...
To change the default number of records loaded, click **Configure list** in the bottom right-hand corner of the list.
...
* Click **Configure list** below and to the right of the list.
* In the list configuration window, double-click the field to be added in the **Available fields** list in order to add it to the **Output columns**. 
...
* If you need, you can click **Distribution of values** to view the repartition of values for the selected field in the current folder.
* Click **OK** to confirm the configuration and display the result.

#### Create a new column {#create-a-new-column}

You can create new columns to display additional fields in the list. To do this:

1. Click **Configure the list** at below and to the right of the list.
1. Click **Add** to display a new field in the list.

#### Remove a column {#remove-a-column}

You can mask one or more columns in a list of records using **Configure list** located below and to the right of the list.

![](assets/s_ncs_user_configure_list.png)

In the list configuration window, select the column to be masked from the **Output columns** zone, and click the delete button.

![](assets/s_ncs_user_removecolumn_icon.png)

Repeat for each column to be masked. Click **OK** to confirm the configuration and display the result.
...
To switch from one display mode to the other, click **Display sub-levels** in the toolbar.
...
1. Select **Properties**.
1. Click **Advanced settings** and then specify a name in the **Configuration** field. 
...
Click **Save** in the folder properties window. The list display is modified to match the specified configuration:
...
1. **Configure list** below and to the right of the list. 

   ![](assets/s_ncs_user_configure_list.png)

1. In the list configuration window, click the **Sorting** tab.
...
1. Click **Ok** to confirm this configuration and display the result in the list.

### Running a search {#running-a-search}

You can run a search of the available fields in an editor using the **Search** field located above the list of fields. Press **Enter** on the keyboard or browse the list. The fields that match your search will have bold labels.
...
<table> 
 <tbody> 
  <tr> 
   <td> <strong>Formats</strong><br /> </td> 
   <td> <strong>English (US)</strong><br /> </td> 
   <td> <strong>English (EN)</strong><br /> </td> 
  </tr> 
  <tr> 
   <td> Date<br /> </td> 
...
Using the input fields with a drop-down list, you can enter an enumeration value, which can be stored and then offered as an option in the drop-down list. For example, in the **City** field of the **General** tab of a recipient profile, you can enter London. When you press Enter to confirm this value, a message asks if you want to save this value for the enumeration associated with the field. 

![](assets/s_ncs_user_wizard_email_bat_substitute_email.png)

If you click **Yes**, this value will be available in the combo box of the relevant field (in this case: **London**).

>[!NOTE]
>
>Enumerations (also known as 'itemized lists') are managed by the administrator via the **Administration > Platform > Enumerations** section. For more on this, refer to [Managing enumerations](../../platform/using/managing-enumerations.md).
