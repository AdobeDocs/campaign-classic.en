...
* Filter on folders, refer to [Filter by folder](https://helpx.adobe.com/campaign/standard/platform/using/filtering-options.html#filter-by-folder),
* Filter by status, refer to [Filter by status](https://helpx.adobe.com/campaign/standard/platform/using/filtering-options.html#filter-by-status), 
* Data sorting, refer to [Order by](https://helpx.adobe.com/campaign/standard/platform/using/filtering-options.html#order-by),
* Search, refer to [Quick search](https://helpx.adobe.com/campaign/standard/platform/using/filtering-options.html#quick-search).
