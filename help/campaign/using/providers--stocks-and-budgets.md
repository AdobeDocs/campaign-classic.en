...
uuid: 1d801fef-78b6-4163-b06f-ae126da72f73
contentOwner: sauviat
products: SG_CAMPAIGN/CLASSIC
content-type: reference
discoiquuid: ac948320-4c23-4142-ab3d-bbdcece86167
index: y
internal: n
snippet: y
---
...
1. Click the **Save** button to add the service provider to the list.
...
1. In the **Services** tab of the service provider, click the **Add** button and name the service template.

   ![](assets/s_ncs_user_supplier_node_create_template.png)

1. Create the cost categories for each type of process (delivery by direct mail/e-mail/etc. or task). To do this, click the **Cost categories** tab and then the **Add** button, and enter the parameters of each cost category.

   ![](assets/s_ncs_user_supplier_node_03.png)

    * Enter a label for this cost category and select the type of process concerned: Delivery by **Direct mail**, **E-mail**, **Mobile**, **Telephone**, **Fax** or **Task**. 
...
1. You can pre-select a value for this cost category, which will be offered by default in the service provider cost categories (instead of a blank). To do this, select the option in the **Selected** column for the type of category concerned:
...
* The **Notification e-mail** section lets you specify the template to notify service providers after files have been sent. Select the template used to create the alert message and the group of recipients.
...
>[!NOTE]
>
>If no cost category is displayed when a service is selected, it means that no cost category was defined for this type of process. For example, for an email delivery, if no **E-mail** type cost category has been defined, no category will be displayed, and selecting the service will have no effect.
...
Adobe Campaign can alert a group of operators if stock has run out or reached a minimum threshold. Stock levels are accessible via the **Stocks** link of the **Campaigns** universe via the **Other choices** link of the navigation area. 
...
In a campaign, when you select the budget you must enter the initial amount. The calculated costs will be updated automatically according to the commitment level of the amounts entered (expenses made, expected, reserved, committed). See [Calculating amounts](../../campaign/using/providers--stocks-and-budgets.md#calculating-amounts).

>[!NOTE]
>
>The procedure for creating budgets is presented in [Creating a budget](../../campaign/using/providers--stocks-and-budgets.md#creating-a-budget).
