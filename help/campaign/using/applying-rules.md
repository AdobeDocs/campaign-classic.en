...
1. Filtering rules:
    ...
    * Native application rules for address qualification: defined address / non-verified address / address from the block list / quarantined address / address quality.
