...
uuid: 3668268b-aeca-4f4b-a74e-c06c24e4ab86
contentOwner: sauviat
products: SG_CAMPAIGN/CLASSIC
content-type: reference
discoiquuid: bc434934-2c1d-4851-bb2a-de6e787cfcd3
index: y
internal: n
snippet: y
---
...
When creating the campaign template, click the **Zoom** icon within the **Web interface** option of the **Advanced campaign settings...** link to access details of the Web application.
...
1. By clicking the **Access your contact list and approve targeting** link, the local entity is given access (via Web browser) to the list of clients selected for the campaign.
...
1. To set up a collaborative campaign (by target approval) you must first create a **Data distribution activity**. Click the **New** icon in the **Resources > Campaign management > Data distribution** node.

   ![](assets/mkg_dist_use_case_target_valid3.png)

1. In the **General** tab, you must specify:
...
1. In the **Breakdown** tab, specify:
...
1. In the **Targeting and workflows** tab, create a workflow for your campaign. This must contain a **Split** activity in which the **Record count limitation** is defined by the **Data distribution** activity.

   ![](assets/mkg_dist_use_case_target_valid5.png)

1. Add a **Local approval** action where you can specify:
...
1. In the **Description** tab, you can add a description for your campaign as well as any documents to be sent to the local entities.
...
1. Create the collaborative campaign.
1. Configure the **Advanced campaign settings...** as you would for a local campaign.
...
1. In the campaign's **Edit** tab, click the **Advanced campaign settings...** link to configure it as a local campaign. Refer to [Creating a local campaign (by form)](../../campaign/using/examples.md#creating-a-local-campaign--by-form-).
...
1. Finalize the package configuration by selecting the approval mode in the **Edit** tab.

   ![](assets/mkg_dist_use_case_form_4.png)

1. From the **Description** tab, you can enter a campaign package description, a notification message to be sent to local entities when the package is published, and attach any informative documents to your campaign package.
