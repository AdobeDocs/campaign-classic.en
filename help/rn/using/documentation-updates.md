...
Learn how to create and manage your campaigns through these new pages: [Create and configure campaign templates](../../campaign/using/marketing-campaign-templates.md), [Marketing campaign deliveries](../../campaign/using/marketing-campaign-deliveries.md), [Select the audience of your campaigns](../../campaign/using/marketing-campaign-target.md),[Manage associated documents](../../campaign/using/marketing-campaign-assets.md) and [Set up and manage the approval process](../../campaign/using/marketing-campaign-approval.md).
