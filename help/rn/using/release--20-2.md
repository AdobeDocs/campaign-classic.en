...
* Fixed issues which could cause the web process to crash. (NEO-27790, NEO-27517)
* Which an issue which caused deliveries to fail when triggered by a non-admin operator. (NEO-28597)
