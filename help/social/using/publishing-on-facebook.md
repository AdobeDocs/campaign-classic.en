...
description: Learn how to publish on Facebook
audience: social
content-type: reference
topic-tags: publishing-on-facebook-twitter
exl-id: 84d6cb2e-c7f9-43d7-a98c-22613d456193
---
# Publish on Facebook{#publishing-on-facebook}
...
### Publish a status with a link {#publishing-a-status-with-a-link}
...
### Publish a status with a YouTube link {#publishing-a-status-with-a-youtube-link}
...
### Publish a photo album {#publishing-a-photo-album}
...
>[!NOTE]
>
>The preview may differ slightly from the final Facebook publication. We highly recommend sending a proof before final delivery for an exact rendering of the publication. [Learn more](#sending-the-proof).
