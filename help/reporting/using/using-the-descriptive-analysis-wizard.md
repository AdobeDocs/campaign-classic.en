...
uuid: cdda42e4-5450-4f1d-a6ce-504ad3f312aa
contentOwner: sauviat
products: SG_CAMPAIGN/CLASSIC
content-type: reference
audience: reporting
discoiquuid: 75bb119d-cbcb-4091-8d75-52026e96a4aa
index: y
internal: n
snippet: y
---
...
* For a set of **recipients**, select the recipients to be analyzed, then right-click and select **Actions > Explore...**, as shown above. If a filter is applied to the list of recipients, only its content will be analyzed.
  ...
  For an example of the descriptive analysis of recipients, refer to: [Qualitative data analysis](../../reporting/using/using-the-descriptive-analysis-wizard.md#qualitative-data-analysis).

* In the context of a **workflow**, place the cursor on a transition that points towards the recipients table, right-click and select **Analyze target**. For more on this, refer to the example in [Analyzing a transition target in a workflow](../../reporting/using/using-the-descriptive-analysis-wizard.md#analyzing-a-transition-target-in-a-workflow).
...
* In the context of a **delivery**, select the deliveries whose target you want to analyze, right-click and select **Actions > Explore the target**, as shown below:
  ...
  Examples of descriptive analyses for deliveries are provided here: [Analyzing a population](../../reporting/using/using-the-descriptive-analysis-wizard.md#analyzing-a-population) and here: [Analyzing recipient tracking logs](../../reporting/using/using-the-descriptive-analysis-wizard.md#analyzing-recipient-tracking-logs).
...
Configuration options available for a report created via the **Qualitative distribution** template are detailed in [Displaying data in the table](../../reporting/using/using-the-descriptive-analysis-wizard.md#displaying-data-in-the-table). A full example is detailed in [Analyzing a population](../../reporting/using/using-the-descriptive-analysis-wizard.md#analyzing-a-population).
...
You can display or hide the name of the statistics and the sub-totals and choose the orientation of the statistics. For more on this, refer to [Analysis report display settings](../../reporting/using/using-the-descriptive-analysis-wizard.md#analysis-report-display-settings).
...
* **Calculated field** to create a personalized operator (available for tables only). The **User function** field lets you enter the calculation to be applied to the data.
  ...
  To do this:
    ...
    1. This statistic won't be displayed in the table. You need to uncheck the **Display in the table** option of the **Advanced** tab. 
    
       ![](assets/report_compute_data_sample3.png)

    1. Create a new **Calculated field** type statistic and enter the following formula in the **User function** field: **@purchases/@count**.
...
The configuration mode of an analysis report created via the **Quantitative distribution** template is detailed in an implementation example [Quantitative data analysis](../../reporting/using/using-the-descriptive-analysis-wizard.md#quantitative-data-analysis).
