...
uuid: 9816b049-c218-4d27-84cf-167056ea60a7
contentOwner: sauviat
products: SG_CAMPAIGN/CLASSIC
content-type: reference
audience: reporting
discoiquuid: 8d50a9c4-bf40-4d9d-baac-81fd2ba8dcb1
index: y
internal: n
snippet: y
---
...
Export options are accessed via the **Page** activities of the report, in the **Advanced** tab.

Change the settings of **Paper** and **Margins** to suit your needs. You can also authorize the exporting of a page in PDF format only. To do this, uncheck the **Activate OpenOffice/Microsoft Excel export** option. 

![](assets/s_ncs_advuser_report_wizard_021.png)

### Exporting into Microsoft Excel {#exporting-into-microsoft-excel}

For **List with group** type reports destined to be exported into Excel, the following recommendations and limitations apply:
...
* The reports do not have to use specific formatting defined at the cell level. It is preferable to use **Form rendering** to define the format of the cells in the table. The **Form rendering** can be accessed via **Administration > Configuration > Form rendering**.
...
* You can force the carriage return in cells: this configuration will be kept in Excel. For more on this, refer to this [Defining cell format](../../reporting/using/actions-on-reports.md#defining-cell-format).
...
For a better result, edit the Internet Explorer printing options and select **Print background colors and images**.
...
It's possible to delete a report archive. To do this, go to the Adobe Campaign node where your reports are stored. Click the **Archives** tab, select the one you want to delete and click **Delete**.
