...
uuid: 9333a7be-d891-476a-bb81-6faaaa13d8d2
contentOwner: sauviat
products: SG_CAMPAIGN/CLASSIC
content-type: reference
discoiquuid: d06d74a3-468c-4c95-979e-708bd01473d6
index: y
internal: n
snippet: y
---
...
For more on this, refer to [Example on the 'ExecuteQuery' method of schema 'xtk:queryDef'](../../configuration/using/data-oriented-apis.md#example-on-the--executequery--method-of-schema--xtk-querydef-).
...
To help with the syntax of a query, you can write the query using the generic query editor in the Adobe Campaign client console (**Tools/ Generic query editor...** menu). To do this:
