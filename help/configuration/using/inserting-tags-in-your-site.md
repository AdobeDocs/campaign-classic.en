...
<html>
  <body>
    ...
    <h1>My site</h1>
    <form action="https://localhost/amount.html">
      Quantity: <input type="text" name="quantity"/><br/><br/>
      Amount: <input type="text" name="amount"/><br/><br/>
      <input value="Save" type="submit">
    </form>
...
The URL you construct must obey the syntax rules defined in [Web tracking tag: definition](https://helpx.adobe.com/campaign/standard/configuration/using/web-tracking-tag--definition.html).
