...
### Map data {#mapping-the-types-of-adobe-campaign-dbms-data}
...
## Reference with XPath {#referencing-with-xpath}
...
## Build a string via the compute string {#building-a-string-via-the-compute-string}
