...
uuid: 645afd97-17f4-48b8-9017-5547866f5f44
contentOwner: sauviat
products: SG_CAMPAIGN/CLASSIC
content-type: reference
discoiquuid: e8319e6e-aa36-4b57-af30-e570bfd10a4d
index: y
internal: n
snippet: y
---
...
The basic structure of an `<srcschema>  is as follows: </srcschema>`
...
A detailed list is available in the description of the [ `<attribute>  element </attribute>`](../../configuration/using/schema-structure.md#attribute--element) and the [ `<element>  element </element>`](../../configuration/using/schema-structure.md#element--element).
...
`<default>  : allows you to pre-fill the field with a default value when creating entities. The value will not be a default SQL value. </default>`

`<sqldefault>  : allows you have an added value when creating a field. This value appears as an SQL result. During a schema update, only the new records will be impacted by this value. </sqldefault>`
