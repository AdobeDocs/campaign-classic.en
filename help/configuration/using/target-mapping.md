...
uuid: 915d380a-d50c-4578-b1b8-07d721cd7bd2
contentOwner: sauviat
products: SG_CAMPAIGN/CLASSIC
content-type: reference
discoiquuid: 112c180a-a5dc-4d6a-bb9e-f2e544259647
index: y
internal: n
snippet: y
---
...
1. Declare your schema as an external view using the ="true" attribute. Refer to [The view attribute](../../configuration/using/target-mapping.md#the-view-attribute).
...
1. Click the **Administration > Campaign management > Target mappings** node.
