...
1. Browse to the folder that lists all recipients in the database.
...
Learn more about data retention in [Campaign Privacy and Security guidelines](../../platform/using/privacy-and-recommendations.md).
