...
The position of labels is applied to elements placed below the container in the hierarchy. It can be overloaded for each element if necessary. Add or remove columns to change the layout. See [Positioning the fields on the page](https://helpx.adobe.com/campaign/standard/web/using/defining-web-forms-layout.html#positioning-the-fields-on-the-page).
