...
uuid: 4737d457-31e5-418a-8eb3-d5d0e8338b24
contentOwner: sauviat
products: SG_CAMPAIGN/CLASSIC
content-type: reference
discoiquuid: 2767d042-21f5-4dfa-a37f-86c1a2e694ff
index: y
internal: n
snippet: y
---
...
>[!CAUTION]
>
>It is highly recommended that the configurations applied be continually checked in order to detect any errors early in the Web application construction process. To check the rendering of a modification, save the application, then click the **Preview** sub-tab.   
