...
uuid: d172667f-1659-414b-a581-07d881dea7a0
contentOwner: sauviat
products: SG_CAMPAIGN/CLASSIC
content-type: reference
discoiquuid: a79a3ab1-89bc-4c92-876f-555dc6b02cc8
index: y
internal: n
snippet: y
---
...
* **Edit link** lets you display a window featuring all the parameters of the link.
* **Break the link** lets you delete, after confirmation, the link and all related parameters.
...
An example is presented in the [Inserting a personalization field](../../web/using/editing-content.md#inserting-a-personalization-field) section.
