...
uuid: a7c94bd6-6b1c-45be-819b-de4eed8fb3b9
contentOwner: sauviat
products: SG_CAMPAIGN/CLASSIC
content-type: reference
discoiquuid: 60ba1c8c-265a-4e3c-9251-ee836d938e5e
index: y
internal: n
snippet: y
---
...
Themes are saved in the **Administration>Configuration>Form rendering** node of the tree. See [Selecting the form rendering template](../../web/using/defining-web-forms-properties.md#selecting-the-form-rendering-template)
...
The **Page** tab lets you define the content of the form header and footer. See [Defining headers and footers](../../web/using/defining-web-forms-properties.md#defining-headers-and-footers).
...
A Web form is accessible to users if it is **Online** and if the current date is within its validity period. The status of the form is modified during the publication stage (see [Publishing a form](../../web/using/defining-web-forms-properties.md#publishing-a-form)). The status is displayed in the **Project** section of the **General** tab of the properties window.
...
You must specify a storage location from which the value of the parameter will be retrieved. To do this, select one of the storage options and then click the **Storage** tab to select the field or the variable concerned. The storage options are detailed in [Response storage fields](../../web/using/defining-web-forms-properties.md#response-storage-fields).
