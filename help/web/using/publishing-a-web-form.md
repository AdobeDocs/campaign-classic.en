...
## Pre-load the form data {#pre-loading-the-form-data}
...
* **[!UICONTROL Adobe Campaign Encryption]**
  ...
  When using this method, you need to adapt the URL of the form to deliver to the email address by adding the **`<%=escapeUrl(recipient.cryptedId) %>`** parameter. For more on this, refer to [Deliver a form via email](#delivering-a-form-via-email).
...
* **[!UICONTROL List of fields]**
  ...
  Fields can be added to the form properties via the **[!UICONTROL Parameters]** tab (refer to [Add parameters](../../web/using/defining-web-forms-properties.md#adding-parameters)). They are placed in the form URL or input zones.
...
## Manage web forms delivery and tracking {#managing-web-forms-delivery-and-tracking}
...
### Publish a form {#publishing-a-form}
...
### Make a form available online {#making-a-form-available-online}
...
### Deliver a form via email {#delivering-a-form-via-email}
...
In this case, the reconciliation key for data storage must be the recipient's encrypted identifier. For more on this, refer to [Pre-load the form data](#pre-loading-the-form-data).

In this case, you need to check the **[!UICONTROL Update the preloaded record]** option in the record box. For more on this, refer to [Save Web forms answers](../../web/using/web-forms-answers.md#saving-web-forms-answers).
