...
uuid: 1c3e33ad-23fe-46ae-bb85-ed3403b9acf2
contentOwner: sauviat
products: SG_CAMPAIGN/CLASSIC
content-type: reference
discoiquuid: 74a5e91d-00c7-4343-9a70-9ed021140c08
index: y
internal: n
snippet: y
---
...
1. Then create the delivery template linked to the information service created during step 1. It will be selected in the **Choose scenario** field of the information service.
...
1. Publish the competition form and send an invitation to the recipients of the initial target. When one of them invites a friend, a delivery based on the **Referral offer** template is created.
   ...
   The referee is added to the visitor folder in the **Administration > Visitors node**:
