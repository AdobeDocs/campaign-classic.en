...
uuid: a24fb78b-dc5a-4a94-b46d-e2dd3f031e00
contentOwner: sauviat
products: SG_CAMPAIGN/CLASSIC
content-type: reference
discoiquuid: f5b16e46-2c0e-4d16-b134-d1d727805f1f
index: y
internal: n
snippet: y
---
...
Please specify the answer registration mode: update a field in the database (stores only the last value saved) or store in a variable (the answer is not stored). For more on this, refer to [Response storage fields](../../web/using/adding-fields-to-a-web-form.md#response-storage-fields).
...
* **Number**: lets the user enter a number on one line. for more on this, refer to [Adding numbers](../../web/using/adding-fields-to-a-web-form.md#adding-numbers).
  ...
  When the page is approved, field content is checked to make sure the value entered is compatible with the field. For more on this, refer to [Defining control settings](../../web/using/adding-fields-to-a-web-form.md#defining-control-settings).
...
>[!NOTE]
>
>Storage modes are detailed in [Response storage fields](../../web/using/adding-fields-to-a-web-form.md#response-storage-fields)

The **Advanced** tab lets you define display parameters for the field (position of labels, alignment, etc.). See [Defining web forms layout](../../web/using/defining-web-forms-layout.md).
...
>[!NOTE]
>
>In our example, the label of the grid is hidden. To do this, go to the **Advanced** tab, the **Label position** display is defined as **Hidden**. See [Defining the position of labels](../../web/using/adding-fields-to-a-web-form.md#defining-the-position-of-labels).
