...
uuid: c069cb75-0d86-48f6-9b8e-cd403b21c3f5
contentOwner: sauviat
products: SG_CAMPAIGN/CLASSIC
content-type: reference
discoiquuid: c9ed474e-017b-4f6f-b55e-fc6cbcb265fb
index: y
internal: n
snippet: y
---
...
When a Web application is created using the HTML content editor - **Digital Content Editor (DCE)** - tracking tags are inserted from the **Properties** tab of the editor. For more information on the Digital Content Editor (DCE), refer to [this section](../../web/using/about-campaign-html-editor.md).
