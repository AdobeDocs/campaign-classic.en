...
uuid: d7469641-8b3a-422e-8ad5-a13c7922e938
contentOwner: sauviat
products: SG_CAMPAIGN/CLASSIC
content-type: reference
discoiquuid: 5ef5eb64-e99d-423f-9081-106e46b3e95d
index: y
internal: n
snippet: y
---
...
1. To make the client console installation program available, copy it into the Adobe Campaign installation directory:
   ...
   >[!NOTE]
   >
   >For more on how to install Adobe Campaign in Linux, refer to [this section](/installation/using/installing-packages.md).
...
1. Start the postupgrade process using the following command (still as **neolane**):
   ...
   >[!NOTE]
   >
   >We strongly recommend upgrading your base to "multi timezone". For further information about timezone options, refer to the [Time zones](../../migration/using/migrating-in-linux-for-adobe-campaign-v7.md#time-zones) section.
...
If you are migrating from v6.02 or earlier, you must configure your security zones before starting services. For more information, refer to [Security](../../migration/using/migrating-in-linux-for-adobe-campaign-v7.md#security).
