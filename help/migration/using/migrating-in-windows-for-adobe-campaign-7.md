...
uuid: 8c687c91-e770-4a22-b816-533772cc21f3
contentOwner: sauviat
products: SG_CAMPAIGN/CLASSIC
content-type: reference
discoiquuid: aa7d0e8b-222a-4b2c-88bd-c1e5a617a832
index: y
internal: n
snippet: y
---
...
1. Create a new website for Adobe Campaign v7:
    ...
    * The access path to the website's basic directory is not used, but the **Physical access path** field must be entered. Enter the default IIS access path: **C:inetpubwwwroot**.
...
If you are migrating from v6.02 or earlier, you must configure your security zones before starting services. For more information, refer to [Security](../../migration/using/migrating-in-windows-for-adobe-campaign-7.md#security).
