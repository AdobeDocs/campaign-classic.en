...
uuid: 86dff765-6dbe-464d-a14f-131378c1f3be
contentOwner: sauviat
products: SG_CAMPAIGN/CLASSIC
content-type: reference
discoiquuid: 0714203a-004d-4fdf-875c-8f11f5615cb5
index: y
internal: n
snippet: y
---
...
* in Linux, the machine to be monitored must have the **bc** package. For more on this, refer to [this section](/installation/using/installing-packages.md#distribution-based-on-rpm--packages).
