...
uuid: bebaf2df-e7ed-485c-9cb4-93b65f920c74
contentOwner: sauviat
products: SG_CAMPAIGN/CLASSIC
content-type: reference
discoiquuid: ef726aa4-250c-4eef-9533-5bc3ef4b426e
index: y
internal: n
snippet: y
---
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> If some logs are missing in the log files, check to make sure that the module is using port 6666. Refer to <a href="../../production/using/modules-and-frequent-issues.md#list-of-open-ports" target="_blank">List of open ports</a>.<br /> </td> 
  </tr> 
  <tr> 
   <td> tracking </td> 
