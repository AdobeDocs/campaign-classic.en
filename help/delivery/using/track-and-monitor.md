...
For more on this, refer to [Configure tracked links in Campaign v8](https://experienceleague.adobe.com/en/docs/campaign/campaign-v8/send/tracked-links){target="_blank"} or [v7-specific tracking features](about-message-tracking.md), and the [Tracking indicators](../../reporting/using/delivery-reports.md#tracking-indicators) description. 
