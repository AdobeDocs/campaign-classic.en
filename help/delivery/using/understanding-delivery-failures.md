...
uuid: a9ba1465-9b59-406f-8348-1ad7aaa945b4
contentOwner: sauviat
products: SG_CAMPAIGN/CLASSIC
content-type: reference
discoiquuid: a53399a3-481d-48f4-bc1b-c484cc0419d2
index: y
internal: n
snippet: y
---
...
* [Delivery logs and history](../../delivery/using/understanding-delivery-failures.md#delivery-logs-and-history)
* [Failed status](../../delivery/using/understanding-delivery-failures.md#failed-status)
...
There are three types of error when a message fails. Each error type determines if an address is sent to quarantines. For more on this, refer to [Conditions for sending an address to quarantine](../../delivery/using/understanding-delivery-failures.md#conditions-for-sending-an-address-to-quarantine)
...
* **Ignore**: the bounce mail was qualified but will not be used by the **Refresh for deliverability** workflow. It will not be sent to client instances.
