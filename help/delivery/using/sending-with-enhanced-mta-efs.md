...
|--- |--- |--- | --- | --- |
| Message is successfully relayed from Campaign to the Enhanced MTA | <ul><li>**[!UICONTROL Success]** percentage starts out at 100%</li></ul>| Sent | <ul><li>**[!UICONTROL Success]** percentage starts out at 0%</li></ul> | Taken into account by the service provider |
| Hard-bouncing messages get reported back from the Enhanced MTA | <ul><li>**[!UICONTROL Success]** percentage is decreased accordingly</li></li></ul> | Failed | <ul><li>No change in **[!UICONTROL Success]** percentage</li></ul> | Failed |
| Soft-bouncing messages get reported back from the Enhanced MTA | <ul><li>No change in **[!UICONTROL Success]** percentage</li></ul> | Sent | <ul><li>No change in **[!UICONTROL Success]** percentage</li></ul> | Taken into account by the service provider |
| Soft-bouncing messages retries are successful | <ul><li>No change in **[!UICONTROL Success]** percentage</li></ul> | Sent | <ul><li>**[!UICONTROL Success]** percentage is increased accordingly</li></ul> | Sent |
| Soft-bouncing messages retries fail | <ul><li>**[!UICONTROL Success]** percentage is decreased accordingly</li></ul> | Failed | <ul><li> No change in **[!UICONTROL Success]** percentage </li></ul> | Failed |
