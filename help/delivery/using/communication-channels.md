...
uuid: f3b511cb-2806-4af5-8c65-a7fa33074902
contentOwner: sauviat
products: SG_CAMPAIGN/CLASSIC
content-type: reference
discoiquuid: 5ff1f174-a8c0-408a-8821-e381f358a141
index: y
internal: n
snippet: y
---
...
External accounts are configured via the ** Administration>Platform>External accounts** node. This configuration should be performed by expert users only.
...
* An external account configured on the **Mobile (SMS)** channel or on the **LINE** channel. 
