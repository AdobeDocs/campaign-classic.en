...
* **[!UICONTROL Social network sharing links]** : inserts buttons that enable the recipient to share a link to the mirror page content with the email client, Facebook, X (formerly known as Twitter), and LinkedIn (see [Viral marketing: forward to a friend](viral-and-social-marketing.md#viral-marketing--forward-to-a-friend)).
