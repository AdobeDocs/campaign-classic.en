...
For more information on the configuration mode, refer to [Linking the template to a delivery](https://helpx.adobe.com/campaign/standard/delivery/using/creating-a-delivery-from-a-template.html#linking-the-template-to-a-delivery).
