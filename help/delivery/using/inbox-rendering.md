...
uuid: 6e4c2db7-339f-4fef-a9a1-edc3c00fede7
contentOwner: sauviat
products: SG_CAMPAIGN/CLASSIC
content-type: reference
discoiquuid: 72886676-f774-44fa-b1b9-c9b76e6bf3fd
index: y
internal: n
snippet: y
---
...
>[!NOTE]
>
>Inbox rendering is not necessary to test personalization in deliveries. Personalization can be checked with Adobe Campaign tools such as **Preview** and [Proofs](../../delivery/using/key-steps-when-creating-a-delivery.md#sending-a-proof).
...
Each time you use the **Inbox rendering** feature in a delivery, each rendering generated decreases your available tokens by one.
...
The number of remaining available tokens is displayed in the **General summary** of the [Inbox rendering report](../../delivery/using/inbox-rendering.md#inbox-rendering-report).
...
1. On the top bar of the delivery, click the **Inbox rendering** button.
1. Select **Analyze** to start the capture process.
...
The **General summary** presents the number of messages received, unwanted (spam), not received, or pending reception, as a list and through a graphical color-coded representation.

![](assets/s_tn_inbox_rendering_summary.png)

Hover over the chart to display the details for each color.

The body of the report is divided into three parts: **Mobile**, **Messaging clients**, and **Webmails**. Scroll down the report to display all the renderings grouped into these three categories.
