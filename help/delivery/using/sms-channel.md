...
1. In the **[!UICONTROL Mobile]** tab, select **[!UICONTROL Extended generic SMPP]** from the **[!UICONTROL Connector]** drop-down list.
   ...
   >[CAUTION]
   >
   > As of release 20.2, available connectors with the exception of **[!UICONTROL Extended generic SMPP]** will be deprecated and not supported. For more on this, refer to this [page](https://helpx.adobe.com/campaign/kb/deprecated-and-removed-features.html).
