...
uuid: a1d854c9-e0fb-4c3b-90aa-8c5db05f0047
contentOwner: sauviat
products: SG_CAMPAIGN/CLASSIC
content-type: reference
discoiquuid: dc3dda5f-b21a-45ce-9dcf-11f7125c1155
index: y
internal: n
snippet: y
---
...
1. Select the **Create a schema** option for content management, then click **Next**.
...
1. Enter the content of the schema in the **Edit schema** window.

   Use the **Insert** button to create the schema content.

   ![](assets/s_ncs_content_param_schema_step2.png)

   For more on this, refer to [Editing schemas](../../delivery/using/use-case--creating-content-management.md#editing-schemas).
...
1. Click **Save** to create the data schema.
...
1. Enter the name of the form and the label linked to the form, then select the **Content management** type.

   ![](assets/s_ncs_content_param_form_edit.png)

   >[!NOTE]
   >
   >To enable both elements to match up automatically, we recommend using the same name as for the linked data schema. Use the **Insert** button above the input zone to add fields from the schema linked to the form.
...
1. Click **Save** to create the input form.
...
1. Import the set content which you want to display in the message.
   ...
   Add the variable elements while respecting the syntax detailed in [JavaScript templates](../../delivery/using/use-case--creating-content-management.md#javascript-templates).
   ...
   Calling up a function at the start of a template lets you set up a call to personalization data taken from the Adobe Campaign database (in this case: recipient.firstName and recipient.lastName), so that it can be interpreted when used in a delivery. For more on this, refer to [Including a JavaScript template](../../delivery/using/use-case--creating-content-management.md#including-a-javascript-template).
...
1. Then enter the name of the template and choose the rendering mode you want to apply. Here, we have a **JavaScript** type rendering based on the template created above.
...
1. Click **Save** to create the publication template.
...
1. Click the **HTML preview** tab to view the rendering. You need to select a recipient to test personalization.
