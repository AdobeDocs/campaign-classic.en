...
uuid: 9bee156a-6120-4d48-909c-2a2ef6552fdb
contentOwner: sauviat
products: SG_CAMPAIGN/CLASSIC
content-type: reference
discoiquuid: c8420f1c-b794-4b05-a91f-6cd6b8579058
index: y
internal: n
snippet: y
---
...
>[!NOTE]
>
>Before creating a LINE account and external account, you first need to install the LINE package on your instance. For more information on this, consult the [LINE](/installation/using/installing-packages.md#line-package) section in the Installation guide.
...
1. In the **Type** field, select Routing and in the **Channel** field, select LINE.
1. Click **Save** to create your LINE external account.
...
>[!NOTE]
>
>You must verify that the **LINE access token update (updateLineAccessToken)** and **Delete blocked LINE users (deleteBlockedLineUsers)** workflows have started. From the explorer, click **Administration > Production > Technical workflows > LINE workflows** to check the status of the workflows.
...
1. In the window that appears, select **LINE V2 delivery** delivery template.
...
1. Click **Continue** to create your delivery.
...
* and **Links**.
  ...
  The **Links** section allows you to choose between different layouts that will divide your image in multiple clickable regions. You can then assign each of them a dedicated link.
...
You can view reports on the LINE service by clicking **Profiles and Targets > Services and Subscriptions > LINE** in the explorer. Then click the **Reports** icon in the LINE service.

![](assets/line_reports.png)

To view reports on LINE deliveries, click **Campaign Management > Deliveries** then select the delivery you want. The tracking reports indicate the click-through rate. LINE does not take the open rate into account.
...
1. Select the **LINE V2 delivery** delivery template and name your delivery.
...
1. Click **Add** to create your message and select the **Message type**.

   Here, we first want to create a text message.

   ![](assets/line_usecase_03.png)

1. Place your cursor in the place where you want to insert the personalized text and click the drop-down icon then select **Visitor > First name**.

   ![](assets/line_usecase_05.png)

1. Follow the same procedure to add an image, selecting **Image and links** in the **Message type** drop-down.

   Add your image URL.

   ![](assets/line_usecase_07.png)

1. In the **Links** section, select the layout that will divide your image in multiple clickable regions.
1. Assign an URL to each region of your image.

   ![](assets/line_usecase_08.png)

1. Save your delivery then click **Send** to analyze and send it to the target.
