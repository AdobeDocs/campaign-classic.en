...
+ Create and send messages {#sending-messages}
     ...
     + [Delivery settings - HIDDEN](delivery/using/delivery-settings.md)
     + Quick start {#key-steps-when-creating-a-delivery}
          + [Get started with deliveries - HIDDEN](delivery/using/steps-about-delivery-creation-steps.md)
          + [Create and identify a delivery - HIDDEN](delivery/using/steps-create-and-identify-the-delivery.md)
          + [Define the audience - HIDDEN](delivery/using/steps-defining-the-target-population.md)
          + [Validate the delivery - HIDDEN](delivery/using/steps-validating-the-delivery.md)
          + [Send the delivery - HIDDEN](delivery/using/steps-sending-the-delivery.md)
          + [Delivery best practices - HIDDEN](delivery/using/delivery-best-practices.md)
     + Delivery best practices {#delivery-bestpractices}
          + [Optimize delivery - HIDDEN](delivery/using/optimize-delivery.md)
          + [Use templates - HIDDEN](delivery/using/use-templates.md)
     ...
     + Send emails {#sending-emails}
          ...
          + [Define the email content - HIDDEN](delivery/using/defining-the-email-content.md)
          + [Define interactive content - HIDDEN](delivery/using/defining-interactive-content.md)
          + Send the email delivery {#sending-an-email}
               + [Main steps to send an email - HIDDEN](delivery/using/sending-messages.md)
               + [Email parameters - HIDDEN](delivery/using/email-parameters.md)
               + [Send on Japanese mobiles - HIDDEN](delivery/using/sending-emails-on-japanese-mobiles.md)
          + [Attach files - HIDDEN](delivery/using/attaching-files.md)
     + Send SMS {#sending-messages-on-mobiles}
          ...
          + [Create a SMS - HIDDEN](delivery/using/sms-create.md)
     ...
     + Send push notifications {#sending-push-notifications}
          ...
          + Configure the mobile application{#configure-the-mobile-app}
               + [Get started with the app configuration - HIDDEN](delivery/using/get-started-app-config.md)
               + [Configuration steps for iOS - HIDDEN](delivery/using/configuring-the-mobile-application.md)
               + [Configuration steps for Android - HIDDEN](delivery/using/configuring-the-mobile-application-android.md)
          + Create a push notification{#create-a-push-msg}
               + [Create a push message for iOS - HIDDEN](delivery/using/create-notifications-ios.md)
               + [Create a push message for Android - HIDDEN](delivery/using/create-notifications-android.md)
          + [Troubleshooting - HIDDEN](delivery/using/troubleshooting.md)
     + [Send direct mails](delivery/using/about-direct-mail-channel.md)
     + Send direct mail {#sending-direct-mail}
          + [Create a direct mail delivery - HIDDEN](delivery/using/creating-a-direct-mail-delivery.md)
          + [Define the direct mail content - HIDDEN](delivery/using/defining-the-direct-mail-content.md)
          + [Validate - HIDDEN](delivery/using/validating.md)
     + Use delivery templates {#using-delivery-templates}
          + [Work with delivery templates - HIDDEN](delivery/using/about-templates.md)
          + [Create a delivery template - HIDDEN](delivery/using/creating-a-delivery-template.md)
          + [Select a target mapping - HIDDEN](delivery/using/selecting-a-target-mapping.md)
...
+ Orchestrate marketing campaigns {#orchestrating-campaigns}
     + [About Campaign Optimization - HIDDEN](campaign-opt/using/about-campaign-optimization.md)
     + About marketing campaigns {#about-marketing-campaigns}
       + [Designing marketing campaigns - HIDDEN](campaign/using/designing-marketing-campaigns.md)
       + [Access marketing campaigns - HIDDEN](campaign/using/accessing-marketing-campaigns.md)  
     + Orchestrate campaigns {#orchestrate-campaigns}
       + [Get started with marketing campaigns - HIDDEN](campaign/using/setting-up-marketing-campaigns.md)
       + [Create and configure templates - HIDDEN](campaign/using/marketing-campaign-templates.md)
       + [Add deliveries - HIDDEN](campaign/using/marketing-campaign-deliveries.md)
       + [Select the audience - HIDDEN](campaign/using/marketing-campaign-target.md)
       + [Manage documents and assets - HIDDEN](campaign/using/marketing-campaign-assets.md)
       + [Set up and manage approvals - HIDDEN](campaign/using/marketing-campaign-approval.md)
       + [Monitor your campaigns - HIDDEN](campaign/using/marketing-campaign-monitoring.md)
       + [Providers, stocks and budgets - HIDDEN](campaign/using/providers-stocks-and-budgets.md)
     + Campaign optimization {#campaign-optimization}
       + [About campaign typologies - HIDDEN](campaign-opt/using/about-campaign-typologies.md)
       + [Pressure rules - HIDDEN](campaign-opt/using/pressure-rules.md)
       + [Consistency rules - HIDDEN](campaign-opt/using/consistency-rules.md)
       + [Control rules - HIDDEN](campaign-opt/using/control-rules.md)
       + [Filtering rules - HIDDEN](campaign-opt/using/filtering-rules.md)
       + [Apply rules - HIDDEN](campaign-opt/using/applying-rules.md)
       + [Campaign simulations - HIDDEN](campaign-opt/using/campaign-simulations.md)
+ Marketing Resource Management {#mrm}
  + [About marketing resource management - HIDDEN](mrm/using/about-marketing-resource-management.md)
  + [Create and manage tasks - HIDDEN](mrm/using/creating-and-managing-tasks.md)
  + [Control costs - HIDDEN](mrm/using/controlling-costs.md)
  + [Manage marketing resources - HIDDEN](mrm/using/managing-marketing-resources.md)
  + [Discussion forums - HIDDEN](mrm/using/discussion-forums.md)
+ Distributed marketing {#distributed-marketing}
  + [About distributed marketing - HIDDEN](distributed/using/about-distributed-marketing.md)
  + [Create a local campaign - HIDDEN](distributed/using/creating-a-local-campaign.md)
  + [Create a collaborative campaign - HIDDEN](distributed/using/creating-a-collaborative-campaign.md)
  + [Publish the campaign package - HIDDEN](distributed/using/publishing-the-campaign-package.md)
  + [Access campaigns - HIDDEN](distributed/using/accessing-campaigns.md)
  + [Track a campaign - HIDDEN](distributed/using/tracking-a-campaign.md)
  + [Use cases - HIDDEN](distributed/using/examples.md)
...
+ Automate with workflows {#automating-with-workflows}
     + Get started with workflows {#introduction}
          + [About activities - HIDDEN](workflow/using/about-activities.md)
          + [Build a workflow - HIDDEN](workflow/using/building-a-workflow.md)
          + [Target data - HIDDEN](workflow/using/targeting-data.md)
          + [Use workflow data - HIDDEN](workflow/using/how-to-use-workflow-data.md)
          + [Workflow best practices - HIDDEN](workflow/using/workflow-best-practices.md)
     + Execute a workflow {#executing-a-workflow}
          + [Start a workflow - HIDDEN](workflow/using/starting-a-workflow.md)
          + [Workflow life cycle - HIDDEN](workflow/using/workflow-life-cycle.md)
          + [Data life cycle - HIDDEN](workflow/using/data-life-cycle.md)
          + [Define approvals - HIDDEN](workflow/using/defining-approvals.md)
          + [Architecture - HIDDEN](workflow/using/architecture.md)
     + Targeting activities {#targeting-activities}
          + [About targeting activities - HIDDEN](workflow/using/about-targeting-activities.md)
          + [Query - HIDDEN](workflow/using/query.md)
          + [Incremental query - HIDDEN](workflow/using/incremental-query.md)
          + [Read list - HIDDEN](workflow/using/read-list.md)
          + [Union - HIDDEN](workflow/using/union.md)
          + [Intersection - HIDDEN](workflow/using/intersection.md)
          + [Exclusion - HIDDEN](workflow/using/exclusion.md)
          + [Split - HIDDEN](workflow/using/split.md)
          + [Cells - HIDDEN](workflow/using/cells.md)
          + [Offers by cell - HIDDEN](workflow/using/offers-by-cell.md)
          + [Delivery outline - HIDDEN](workflow/using/delivery-outline.md)
          + [Enrichment - HIDDEN](workflow/using/enrichment.md)
          + [Edit schema - HIDDEN](workflow/using/edit-schema.md)
          + [Offer engine - HIDDEN](workflow/using/offer-engine.md)
          + [Deduplication - HIDDEN](workflow/using/deduplication.md)
          + [Change dimension - HIDDEN](workflow/using/change-dimension.md)
          + [List update - HIDDEN](workflow/using/list-update.md)
          + [Subscription Services - HIDDEN](workflow/using/subscription-services.md)
          + [Update data - HIDDEN](workflow/using/update-data.md)
          + [CRM Connector - HIDDEN](workflow/using/crm-connector.md)
          + [Change data source - HIDDEN](workflow/using/change-data-source.md)
     + Flow control activities {#flow-control-activities}
          + [About flow control activities - HIDDEN](workflow/using/about-flow-control-activities.md)
          + [Start and end - HIDDEN](workflow/using/start-and-end.md)
          + [Fork - HIDDEN](workflow/using/fork.md)
          ...
          + [Time constraint - HIDDEN](workflow/using/time-constraint.md)
          + [Sub-workflow - HIDDEN](workflow/using/sub-workflow.md)
          + [Jump (start point and end point - HIDDEN)](workflow/using/jump-start-point-and-end-point.md)
          + [External signal - HIDDEN](workflow/using/external-signal.md)
          + [Approval - HIDDEN](workflow/using/approval.md)
          + [Alert - HIDDEN](workflow/using/alert.md)
          + [Task - HIDDEN](workflow/using/task.md)
     + Action activities {#action-activities}
          + [About action activities - HIDDEN](workflow/using/about-action-activities.md)
          + [Delivery - HIDDEN](workflow/using/delivery.md)
          + [Delivery control - HIDDEN](workflow/using/delivery-control.md)
          + [Continuous delivery - HIDDEN](workflow/using/continuous-delivery.md)
          + [Recurring delivery - HIDDEN](workflow/using/recurring-delivery.md)
          + [Cross-channel deliveries - HIDDEN](workflow/using/cross-channel-deliveries.md)
          + [Local approval - HIDDEN](workflow/using/local-approval.md)
          + [Data loading (RDBMS) - HIDDEN](workflow/using/data-loading-rdbms.md)
          + [Loading (SOAP) - HIDDEN](workflow/using/loading-soap.md)
          + [Data loading (file) - HIDDEN](workflow/using/data-loading-file.md)
          + [Content Management - HIDDEN](workflow/using/content-management.md)
          + [Data extraction (file) - HIDDEN](workflow/using/extraction-file.md)
          + [SQL code and JavaScript code - HIDDEN](workflow/using/sql-code-and-javascript-code.md)
          + [SQL Data Management - HIDDEN](workflow/using/sql-data-management.md)
          + [Nlserver module - HIDDEN](workflow/using/nlserver-module.md)
          + [Update aggregate - HIDDEN](workflow/using/update-aggregate.md)
     + Event activities {#event-activities}
          + [About event activities - HIDDEN](workflow/using/about-event-activities.md)
          + [File collector - HIDDEN](workflow/using/file-collector.md)
          + [File transfer - HIDDEN](workflow/using/file-transfer.md)
          + [Web download - HIDDEN](workflow/using/web-download.md)
          + [Inbound Emails - HIDDEN](workflow/using/inbound-emails.md)
          + [Inbound SMS - HIDDEN](workflow/using/inbound-sms.md)
     + Use cases {#use-cases}
          + [About workflow use cases - HIDDEN](workflow/using/about-workflow-use-cases.md)
          + Deliveries {#deliveries}
               + [Use the local approval activity - HIDDEN](workflow/using/using-the-local-approval-activity.md)
               + [Send a birthday email - HIDDEN](workflow/using/sending-a-birthday-email.md)
               + [Load delivery content - HIDDEN](workflow/using/loading-delivery-content.md)
               + [Cross-channel delivery workflow - HIDDEN](workflow/using/cross-channel-delivery-workflow.md)
               + [Email enrichment with custom date fields - HIDDEN](workflow/using/email-enrichment-with-custom-date-fields.md)
     + Monitoring {#monitoring}
          + [Send a report to a list - HIDDEN](workflow/using/sending-a-report-to-a-list.md)
          + [Supervise your workflows - HIDDEN](workflow/using/supervising-workflows.md)
          + [Send personalized alerts to operators - HIDDEN](workflow/using/sending-personalized-alerts-to-operators.md)
     + Data management {#data-management}   
          + [Coordinate data updates - HIDDEN](workflow/using/coordinating-data-updates.md)
          + [Create a summary list - HIDDEN](workflow/using/creating-a-summary-list.md)
          + [Enrich data - HIDDEN](workflow/using/enriching-data.md) 
          + [Use aggregates - HIDDEN](workflow/using/using-aggregates.md)
          + [Use the Deduplication activity's merge functionality - HIDDEN](workflow/using/deduplication-merge.md)
     ...
     + Query and filter {#designing-queries}
          ...
          + [Query using grouping management - HIDDEN](workflow/using/querying-using-grouping-management.md)
          + [Query using a many-to-many-relationship - HIDDEN](workflow/using/querying-using-many-to-many-relationship.md)
          + [Add an enumeration type calculated field - HIDDEN](workflow/using/adding-enumeration-type-calculated-field.md)
          + [Create a filter - HIDDEN](workflow/using/creating-a-filter.md)
          + [Filter duplicated recipients - HIDDEN](workflow/using/filtering-duplicated-recipients.md)
     + Monitor workflows {#monitoring-workflows}
          + [Monitor workflow execution - HIDDEN](workflow/using/monitoring-workflow-execution.md)
          + [Monitor technical workflows - HIDDEN](workflow/using/monitoring-technical-workflows.md)
          + [Workflow HeatMap - HIDDEN](workflow/using/heatmap.md)
     + Advanced management {#advanced-management}
          + [Workflow properties - HIDDEN](workflow/using/workflow-properties.md)
          + [Advanced parameters - HIDDEN](workflow/using/advanced-parameters.md)
          + [JavaScript scripts and templates - HIDDEN](workflow/using/javascript-scripts-and-templates.md)
          + [Examples of JavaScript code in workflows - HIDDEN](workflow/using/javascript-in-workflows.md)
          + [Access an external database - HIDDEN](workflow/using/accessing-an-external-database-fda.md)
          + [Manage permissions - HIDDEN](workflow/using/managing-rights.md)
          + [Change activity images - HIDDEN](workflow/using/managing-activity-images.md)
          + [Manage time zones - HIDDEN](workflow/using/managing-time-zones.md)
          + [Technical workflows - HIDDEN](workflow/using/about-technical-workflows.md)
