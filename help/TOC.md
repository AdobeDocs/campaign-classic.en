...
+ Release notes {#release-notes}
  ...
  + {hide-from-toc} [Documentation updates - HIDDEN](rn/using/documentation-updates.md)
+ Get started {#getting-started}
     ...
     + {hide-from-toc} [Use Campaign Explorer - HIDDEN](platform/using/adobe-campaign-explorer.md)
     + {hide-from-toc} [Browse and customize lists - HIDDEN](platform/using/adobe-campaign-ui-lists.md)
     + {hide-from-toc} [Enumerations - HIDDEN](platform/using/managing-enumerations.md)
     ...
     + {hide-from-toc} [Glossary - HIDDEN](platform/using/ac-glossary.md)
     + Privacy {#privacy}
     ...
     + Profile management {#profile-management}
          ...
          + {hide-from-toc} [Edit a profile - HIDDEN](platform/using/editing-a-profile.md)
          + {hide-from-toc} [Add profiles - HIDDEN](platform/using/adding-profiles.md)
          + {hide-from-toc} [Manage profiles - HIDDEN](platform/using/managing-profiles.md)
          + [Update data](platform/using/updating-data.md)
          + {hide-from-toc} [Import and export profiles - HIDDEN](platform/using/exporting-and-importing-profiles.md)
     ...
     + Filter data {#filtering-data}
          + {hide-from-toc} [Filtering options - HIDDEN](platform/using/filtering-options.md)
          + {hide-from-toc} [Create filters - HIDDEN](platform/using/creating-filters.md)
          + {hide-from-toc} [Use case - Hidden](platform/using/use-case.md)
     + {hide-from-toc} [Steps to create a query - HIDDEN](platform/using/steps-to-create-a-query.md)
     + {hide-from-toc} [Define filter conditions - HIDDEN](platform/using/defining-filter-conditions.md)
     + Permissions {#permissions}
          ...
          + {hide-from-toc} [Manage access to folders - HIDDEN](platform/using/access-management-folders.md)
     + CRM connectors {#connectors}
          + [Get started with CRM Connectors](platform/using/crm-connectors.md)
          + {hide-from-toc} [Connect with Microsoft Dynamics 365](platform/using/crm-ms-dynamics.md)
          + {hide-from-toc} [Connect with Salesforce.com](platform/using/crm-sfdc.md)
          + {hide-from-toc} [Synchronize data with the CRM](platform/using/crm-data-sync.md)
     + {hide-from-toc} [Help & support options - HIDDEN](support.md)
+ Create and send messages {#sending-messages}
     + [Get started with messages](delivery/using/communication-channels.md)
     + {hide-from-toc} [Delivery settings - HIDDEN](delivery/using/delivery-settings.md)
     + Quick start {#key-steps-when-creating-a-delivery}
          + {hide-from-toc} [Get started with deliveries - HIDDEN](delivery/using/steps-about-delivery-creation-steps.md)
          + {hide-from-toc} [Create and identify a delivery - HIDDEN](delivery/using/steps-create-and-identify-the-delivery.md)
          + {hide-from-toc} [Define the audience - HIDDEN](delivery/using/steps-defining-the-target-population.md)
          + {hide-from-toc} [Validate the delivery - HIDDEN](delivery/using/steps-validating-the-delivery.md)
          + {hide-from-toc} [Send the delivery - HIDDEN](delivery/using/steps-sending-the-delivery.md)
          + {hide-from-toc} [Delivery best practices - HIDDEN](delivery/using/delivery-best-practices.md)
     + Delivery best practices {#delivery-bestpractices}
          + {hide-from-toc} [Optimize delivery - HIDDEN](delivery/using/optimize-delivery.md)
          + {hide-from-toc} [Use templates - HIDDEN](delivery/using/use-templates.md)
          + {hide-from-toc} [Build personalized content - HIDDEN](delivery/using/design-and-personalize.md)
          + {hide-from-toc} [Define the right audience - HIDDEN](delivery/using/define-the-right-audience.md)
          + {hide-from-toc} [Check before sending - HIDDEN](delivery/using/check-before-sending.md)
     + [Send emails](delivery/using/about-email-channel.md)
     + Send emails {#sending-emails}
          + {hide-from-toc} [Create an email delivery - HIDDEN](delivery/using/creating-an-email-delivery.md)
          + {hide-from-toc} [Define the email content - HIDDEN](delivery/using/defining-the-email-content.md)
          + {hide-from-toc} [Define interactive content - HIDDEN](delivery/using/defining-interactive-content.md)
          + Send the email delivery {#sending-an-email}
               + {hide-from-toc} [Main steps to send an email - HIDDEN](delivery/using/sending-messages.md)
               + {hide-from-toc} [Email parameters - HIDDEN](delivery/using/email-parameters.md)
               + {hide-from-toc} [Send on Japanese mobiles - HIDDEN](delivery/using/sending-emails-on-japanese-mobiles.md)
          + {hide-from-toc} [Attach files - HIDDEN](delivery/using/attaching-files.md)
     + Send SMS {#sending-messages-on-mobiles}
          ...
          + {hide-from-toc} [Create a SMS - HIDDEN](delivery/using/sms-create.md)
          + {hide-from-toc} [Migrate to the Extended Generic SMPP connector](delivery/using/unsupported-connector-migration.md)
     ...
     + Send push notifications {#sending-push-notifications}
          + {hide-from-toc} [Integrate Campaign SDK into the mobile application](delivery/using/integrating-campaign-sdk-into-the-mobile-application.md)
          + Configure the mobile application{#configure-the-mobile-app}
               + {hide-from-toc} [Get started with the app configuration - HIDDEN](delivery/using/get-started-app-config.md)
               + {hide-from-toc} [Configuration steps for iOS - HIDDEN](delivery/using/configuring-the-mobile-application.md)
               + {hide-from-toc} [Configuration steps for Android - HIDDEN](delivery/using/configuring-the-mobile-application-android.md)
          + Create a push notification{#create-a-push-msg}
               + {hide-from-toc} [Create a push message for iOS - HIDDEN](delivery/using/create-notifications-ios.md)
               + {hide-from-toc} [Create a push message for Android - HIDDEN](delivery/using/create-notifications-android.md)
          + {hide-from-toc} [Troubleshooting - HIDDEN](delivery/using/troubleshooting.md)
     + [Send direct mails](delivery/using/about-direct-mail-channel.md)
     + Send direct mail {#sending-direct-mail}
          + {hide-from-toc} [Create a direct mail delivery - HIDDEN](delivery/using/creating-a-direct-mail-delivery.md)
          + {hide-from-toc} [Define the direct mail content - HIDDEN](delivery/using/defining-the-direct-mail-content.md)
          + {hide-from-toc} [Validate - HIDDEN](delivery/using/validating.md)
     + Use delivery templates {#using-delivery-templates}
          + {hide-from-toc} [Work with delivery templates - HIDDEN](delivery/using/about-templates.md)
          + {hide-from-toc} [Create a delivery template - HIDDEN](delivery/using/creating-a-delivery-template.md)
          + {hide-from-toc} [Select a target mapping - HIDDEN](delivery/using/selecting-a-target-mapping.md)
          + {hide-from-toc} [Create a delivery from a template - HIDDEN](delivery/using/creating-a-delivery-from-a-template.md)
     + Personalize deliveries {#personalizing-deliveries}
          + [About personalization](delivery/using/about-personalization.md)
          + {hide-from-toc} [Personalization fields - HIDDEN](delivery/using/personalization-fields.md)
          + {hide-from-toc} [Personalization blocks - HIDDEN](delivery/using/personalization-blocks.md)
          + {hide-from-toc} [Conditional content - HIDDEN](delivery/using/conditional-content.md)
          + {hide-from-toc} [Personalized coupons - HIDDEN](delivery/using/personalized-coupons.md)
          + {hide-from-toc} [Generate personalized PDF documents - HIDDEN](delivery/using/generating-personalized-pdf-documents.md)
          + {hide-from-toc} [Customize the emoticon list](delivery/using/customizing-emoticon-list.md)
...
+ Orchestrate marketing campaigns {#orchestrating-campaigns}
     + {hide-from-toc} [About Campaign Optimization - HIDDEN](campaign-opt/using/about-campaign-optimization.md)
     + About marketing campaigns {#about-marketing-campaigns}
       + {hide-from-toc} [Designing marketing campaigns - HIDDEN](campaign/using/designing-marketing-campaigns.md)
       + {hide-from-toc} [Access marketing campaigns - HIDDEN](campaign/using/accessing-marketing-campaigns.md)  
     + Orchestrate campaigns {#orchestrate-campaigns}
       + {hide-from-toc} [Get started with marketing campaigns - HIDDEN](campaign/using/setting-up-marketing-campaigns.md)
       + {hide-from-toc} [Create and configure templates - HIDDEN](campaign/using/marketing-campaign-templates.md)
       + {hide-from-toc} [Add deliveries - HIDDEN](campaign/using/marketing-campaign-deliveries.md)
       + {hide-from-toc} [Select the audience - HIDDEN](campaign/using/marketing-campaign-target.md)
       + {hide-from-toc} [Manage documents and assets - HIDDEN](campaign/using/marketing-campaign-assets.md)
       + {hide-from-toc} [Set up and manage approvals - HIDDEN](campaign/using/marketing-campaign-approval.md)
       + {hide-from-toc} [Monitor your campaigns - HIDDEN](campaign/using/marketing-campaign-monitoring.md)
       + {hide-from-toc} [Providers, stocks and budgets - HIDDEN](campaign/using/providers-stocks-and-budgets.md)
     + Campaign optimization {#campaign-optimization}
       + {hide-from-toc} [About campaign typologies - HIDDEN](campaign-opt/using/about-campaign-typologies.md)
       + {hide-from-toc} [Pressure rules - HIDDEN](campaign-opt/using/pressure-rules.md)
       + {hide-from-toc} [Consistency rules - HIDDEN](campaign-opt/using/consistency-rules.md)
       + {hide-from-toc} [Control rules - HIDDEN](campaign-opt/using/control-rules.md)
       + {hide-from-toc} [Filtering rules - HIDDEN](campaign-opt/using/filtering-rules.md)
       + {hide-from-toc} [Apply rules - HIDDEN](campaign-opt/using/applying-rules.md)
       + {hide-from-toc} [Campaign simulations - HIDDEN](campaign-opt/using/campaign-simulations.md)
+ Marketing Resource Management {#mrm}
  + {hide-from-toc} [About marketing resource management - HIDDEN](mrm/using/about-marketing-resource-management.md)
  + {hide-from-toc} [Create and manage tasks - HIDDEN](mrm/using/creating-and-managing-tasks.md)
  + {hide-from-toc} [Control costs - HIDDEN](mrm/using/controlling-costs.md)
  + {hide-from-toc} [Manage marketing resources - HIDDEN](mrm/using/managing-marketing-resources.md)
  + {hide-from-toc} [Discussion forums - HIDDEN](mrm/using/discussion-forums.md)
+ Distributed marketing {#distributed-marketing}
  + {hide-from-toc} [About distributed marketing - HIDDEN](distributed/using/about-distributed-marketing.md)
  + {hide-from-toc} [Create a local campaign - HIDDEN](distributed/using/creating-a-local-campaign.md)
  + {hide-from-toc} [Create a collaborative campaign - HIDDEN](distributed/using/creating-a-collaborative-campaign.md)
  + {hide-from-toc} [Publish the campaign package - HIDDEN](distributed/using/publishing-the-campaign-package.md)
  + {hide-from-toc} [Access campaigns - HIDDEN](distributed/using/accessing-campaigns.md)
  + {hide-from-toc} [Track a campaign - HIDDEN](distributed/using/tracking-a-campaign.md)
  + {hide-from-toc} [Use cases - HIDDEN](distributed/using/examples.md)
...
+ Integrate with Adobe Experience Cloud {#integrating-with-adobe-experience-cloud}
     ...
     + Audience sharing {#audience-sharing}
          ...
          + {hide-from-toc} [Troubleshooting](integrations/using/troubleshooting.md)
     ...
     + ACS Connector {#acs-connector}
          + {hide-from-toc} [Get started with [!DNL ACS Connector] - HIDDEN](integrations/using/acs-connector-principles-and-data-cycle.md)
          + {hide-from-toc} [Synchronize profiles - HIDDEN](integrations/using/synchronizing-profiles.md)
          + {hide-from-toc} [Synchronize audiences - HIDDEN](integrations/using/synchronizing-audiences.md)
          + {hide-from-toc} [Synchronize web applications - HIDDEN](integrations/using/synchronizing-web-applications.md)
          + {hide-from-toc} [Troubleshoot the [!DNL ACS Connector] - HIDDEN](integrations/using/troubleshooting-the-acs-connector.md)
+ [Automate with workflows](workflow/using/about-workflows.md)
+ Automate with workflows {#automating-with-workflows}
     + Get started with workflows {#introduction}
          + {hide-from-toc} [About activities - HIDDEN](workflow/using/about-activities.md)
          + {hide-from-toc} [Build a workflow - HIDDEN](workflow/using/building-a-workflow.md)
          + {hide-from-toc} [Target data - HIDDEN](workflow/using/targeting-data.md)
          + {hide-from-toc} [Use workflow data - HIDDEN](workflow/using/how-to-use-workflow-data.md)
          + {hide-from-toc} [Workflow best practices - HIDDEN](workflow/using/workflow-best-practices.md)
     + Execute a workflow {#executing-a-workflow}
          + {hide-from-toc} [Start a workflow - HIDDEN](workflow/using/starting-a-workflow.md)
          + {hide-from-toc} [Workflow life cycle - HIDDEN](workflow/using/workflow-life-cycle.md)
          + {hide-from-toc} [Data life cycle - HIDDEN](workflow/using/data-life-cycle.md)
          + {hide-from-toc} [Define approvals - HIDDEN](workflow/using/defining-approvals.md)
          + {hide-from-toc} [Architecture - HIDDEN](workflow/using/architecture.md)
     + Targeting activities {#targeting-activities}
          + {hide-from-toc} [About targeting activities - HIDDEN](workflow/using/about-targeting-activities.md)
          + {hide-from-toc} [Query - HIDDEN](workflow/using/query.md)
          + {hide-from-toc} [Incremental query - HIDDEN](workflow/using/incremental-query.md)
          + {hide-from-toc} [Read list - HIDDEN](workflow/using/read-list.md)
          + {hide-from-toc} [Union - HIDDEN](workflow/using/union.md)
          + {hide-from-toc} [Intersection - HIDDEN](workflow/using/intersection.md)
          + {hide-from-toc} [Exclusion - HIDDEN](workflow/using/exclusion.md)
          + {hide-from-toc} [Split - HIDDEN](workflow/using/split.md)
          + {hide-from-toc} [Cells - HIDDEN](workflow/using/cells.md)
          + {hide-from-toc} [Offers by cell - HIDDEN](workflow/using/offers-by-cell.md)
          + {hide-from-toc} [Delivery outline - HIDDEN](workflow/using/delivery-outline.md)
          + {hide-from-toc} [Enrichment - HIDDEN](workflow/using/enrichment.md)
          + {hide-from-toc} [Edit schema - HIDDEN](workflow/using/edit-schema.md)
          + {hide-from-toc} [Offer engine - HIDDEN](workflow/using/offer-engine.md)
          + {hide-from-toc} [Deduplication - HIDDEN](workflow/using/deduplication.md)
          + {hide-from-toc} [Change dimension - HIDDEN](workflow/using/change-dimension.md)
          + {hide-from-toc} [List update - HIDDEN](workflow/using/list-update.md)
          + {hide-from-toc} [Subscription Services - HIDDEN](workflow/using/subscription-services.md)
          + {hide-from-toc} [Update data - HIDDEN](workflow/using/update-data.md)
          + {hide-from-toc} [CRM Connector - HIDDEN](workflow/using/crm-connector.md)
          + {hide-from-toc} [Change data source - HIDDEN](workflow/using/change-data-source.md)
     + Flow control activities {#flow-control-activities}
          + {hide-from-toc} [About flow control activities - HIDDEN](workflow/using/about-flow-control-activities.md)
          + {hide-from-toc} [Start and end - HIDDEN](workflow/using/start-and-end.md)
          + {hide-from-toc} [Fork - HIDDEN](workflow/using/fork.md)
          + {hide-from-toc} [AND-join - HIDDEN](workflow/using/and-join.md)
          + {hide-from-toc} [Scheduler - HIDDEN](workflow/using/scheduler.md)
          + {hide-from-toc} [Test - HIDDEN](workflow/using/test.md)
          + {hide-from-toc} [Wait - HIDDEN](workflow/using/wait.md)
          + {hide-from-toc} [Time constraint - HIDDEN](workflow/using/time-constraint.md)
          + {hide-from-toc} [Sub-workflow - HIDDEN](workflow/using/sub-workflow.md)
          + {hide-from-toc} [Jump (start point and end point - HIDDEN)](workflow/using/jump-start-point-and-end-point.md)
          + {hide-from-toc} [External signal - HIDDEN](workflow/using/external-signal.md)
          + {hide-from-toc} [Approval - HIDDEN](workflow/using/approval.md)
          + {hide-from-toc} [Alert - HIDDEN](workflow/using/alert.md)
          + {hide-from-toc} [Task - HIDDEN](workflow/using/task.md)
     + Action activities {#action-activities}
          + {hide-from-toc} [About action activities - HIDDEN](workflow/using/about-action-activities.md)
          + {hide-from-toc} [Delivery - HIDDEN](workflow/using/delivery.md)
          + {hide-from-toc} [Delivery control - HIDDEN](workflow/using/delivery-control.md)
          + {hide-from-toc} [Continuous delivery - HIDDEN](workflow/using/continuous-delivery.md)
          + {hide-from-toc} [Recurring delivery - HIDDEN](workflow/using/recurring-delivery.md)
          + {hide-from-toc} [Cross-channel deliveries - HIDDEN](workflow/using/cross-channel-deliveries.md)
          + {hide-from-toc} [Local approval - HIDDEN](workflow/using/local-approval.md)
          + {hide-from-toc} [Data loading (RDBMS) - HIDDEN](workflow/using/data-loading-rdbms.md)
          + {hide-from-toc} [Loading (SOAP) - HIDDEN](workflow/using/loading-soap.md)
          + {hide-from-toc} [Data loading (file) - HIDDEN](workflow/using/data-loading-file.md)
          + {hide-from-toc} [Content Management - HIDDEN](workflow/using/content-management.md)
          + {hide-from-toc} [Data extraction (file) - HIDDEN](workflow/using/extraction-file.md)
          + {hide-from-toc} [SQL code and JavaScript code - HIDDEN](workflow/using/sql-code-and-javascript-code.md)
          + {hide-from-toc} [SQL Data Management - HIDDEN](workflow/using/sql-data-management.md)
          + {hide-from-toc} [Nlserver module - HIDDEN](workflow/using/nlserver-module.md)
          + {hide-from-toc} [Update aggregate - HIDDEN](workflow/using/update-aggregate.md)
     + Event activities {#event-activities}
          + {hide-from-toc} [About event activities - HIDDEN](workflow/using/about-event-activities.md)
          + {hide-from-toc} [File collector - HIDDEN](workflow/using/file-collector.md)
          + {hide-from-toc} [File transfer - HIDDEN](workflow/using/file-transfer.md)
          + {hide-from-toc} [Web download - HIDDEN](workflow/using/web-download.md)
          + {hide-from-toc} [Inbound Emails - HIDDEN](workflow/using/inbound-emails.md)
          + {hide-from-toc} [Inbound SMS - HIDDEN](workflow/using/inbound-sms.md)
     + Use cases {#use-cases}
          + {hide-from-toc} [About workflow use cases - HIDDEN](workflow/using/about-workflow-use-cases.md)
          + Deliveries {#deliveries}
               + {hide-from-toc} [Use the local approval activity - HIDDEN](workflow/using/using-the-local-approval-activity.md)
               + {hide-from-toc} [Send a birthday email - HIDDEN](workflow/using/sending-a-birthday-email.md)
               + {hide-from-toc} [Load delivery content - HIDDEN](workflow/using/loading-delivery-content.md)
               + {hide-from-toc} [Cross-channel delivery workflow - HIDDEN](workflow/using/cross-channel-delivery-workflow.md)
               + {hide-from-toc} [Email enrichment with custom date fields - HIDDEN](workflow/using/email-enrichment-with-custom-date-fields.md)
     + Monitoring {#monitoring}
          + {hide-from-toc} [Send a report to a list - HIDDEN](workflow/using/sending-a-report-to-a-list.md)
          + {hide-from-toc} [Supervise your workflows - HIDDEN](workflow/using/supervising-workflows.md)
          + {hide-from-toc} [Send personalized alerts to operators - HIDDEN](workflow/using/sending-personalized-alerts-to-operators.md)
     + Data management {#data-management}   
          + {hide-from-toc} [Coordinate data updates - HIDDEN](workflow/using/coordinating-data-updates.md)
          + {hide-from-toc} [Create a summary list - HIDDEN](workflow/using/creating-a-summary-list.md)
          + {hide-from-toc} [Enrich data - HIDDEN](workflow/using/enriching-data.md) 
          + {hide-from-toc} [Use aggregates - HIDDEN](workflow/using/using-aggregates.md)
          + {hide-from-toc} [Use the Deduplication activity's merge functionality - HIDDEN](workflow/using/deduplication-merge.md)
          + {hide-from-toc} [Set up a recurring import workflow - HIDDEN](workflow/using/recurring-import-workflow.md)
     + Design queries {#designing-queries}
          + {hide-from-toc} [Quarterly list update using an incremental query - HIDDEN](workflow/using/quarterly-list-update.md)
     + Query and filter {#query-and-filter-hidden}
          + {hide-from-toc} [Query the recipient table - HIDDEN](workflow/using/querying-recipient-table.md)
          + {hide-from-toc} [Query delivery information - HIDDEN](workflow/using/querying-delivery-information.md)
          + {hide-from-toc} [Perform aggregate computing - HIDDEN](workflow/using/performing-aggregate-computing.md)
          + {hide-from-toc} [Query using grouping management - HIDDEN](workflow/using/querying-using-grouping-management.md)
          + {hide-from-toc} [Query using a many-to-many-relationship - HIDDEN](workflow/using/querying-using-many-to-many-relationship.md)
          + {hide-from-toc} [Add an enumeration type calculated field - HIDDEN](workflow/using/adding-enumeration-type-calculated-field.md)
          + {hide-from-toc} [Create a filter - HIDDEN](workflow/using/creating-a-filter.md)
          + {hide-from-toc} [Filter duplicated recipients - HIDDEN](workflow/using/filtering-duplicated-recipients.md)
     + Monitor workflows {#monitoring-workflows}
          + {hide-from-toc} [Monitor workflow execution - HIDDEN](workflow/using/monitoring-workflow-execution.md)
          + {hide-from-toc} [Monitor technical workflows - HIDDEN](workflow/using/monitoring-technical-workflows.md)
          + {hide-from-toc} [Workflow HeatMap - HIDDEN](workflow/using/heatmap.md)
     + Advanced management {#advanced-management}
          + {hide-from-toc} [Workflow properties - HIDDEN](workflow/using/workflow-properties.md)
          + {hide-from-toc} [Advanced parameters - HIDDEN](workflow/using/advanced-parameters.md)
          + {hide-from-toc} [JavaScript scripts and templates - HIDDEN](workflow/using/javascript-scripts-and-templates.md)
          + {hide-from-toc} [Examples of JavaScript code in workflows - HIDDEN](workflow/using/javascript-in-workflows.md)
          + {hide-from-toc} [Access an external database - HIDDEN](workflow/using/accessing-an-external-database-fda.md)
          + {hide-from-toc} [Manage permissions - HIDDEN](workflow/using/managing-rights.md)
          + {hide-from-toc} [Change activity images - HIDDEN](workflow/using/managing-activity-images.md)
          + {hide-from-toc} [Manage time zones - HIDDEN](workflow/using/managing-time-zones.md)
          + {hide-from-toc} [Technical workflows - HIDDEN](workflow/using/about-technical-workflows.md)
...
+ Installation and configuration guide {#installing-campaign-classic}
     ...
     + Configure Campaign {#additional-configurations}
          ...
          + {hide-from-toc} [Using MX servers with Campaign](installation/using/using-mx-servers.md)
     ...
     + Appendices {#appendices}
          ...
          + {hide-from-toc} [Uninstall Campaign](installation/using/uninstalling-campaign.md)
...
+ Monitoring guide {#monitoring-campaign-classic}
     ...
     + Update Adobe Campaign {#updating-adobe-campaign}
          ...
          + {hide-from-toc} [Migration procedures](production/using/migration-procedures.md)
...
+ Migration guide {#migrating-to-a-new-version}
     + {hide-from-toc} [Migrate to Adobe Campaign v7](migration/using/about-migration.md)
     + Migration procedure {#migration-procedure}
          + {hide-from-toc} [Prerequisites](migration/using/before-starting-migration.md)
          + {hide-from-toc} [About migration tests](migration/using/testing-the-migration.md)
          + {hide-from-toc} [Adapt your configuration](migration/using/configuring-your-platform.md)
     + Start the migration {#migrating-to-adobe-campaign-7}
          + {hide-from-toc} [Migrate a Microsoft Windows platform](migration/using/migrating-in-windows-for-adobe-campaign-7.md)
          + {hide-from-toc} [Migrate a Linux platform](migration/using/migrating-in-linux-for-adobe-campaign-v7.md)
     + {hide-from-toc} [Rollback procedure](migration/using/about-rollback.md)
+ Technotes {#technotes}
     ...
     + Upgrades and compatibility{#technote-migration}
          ...
          + {hide-from-toc} [New deliverabiity server](technotes/using/deliverability-server.md)
          + {hide-from-toc} [Apache Security Upgrade](technotes/using/acc-apache-upgrade.md)
     ...
     + Emails and push notifications{#technotes-email}
          ...
          + {hide-from-toc} [Update incorrect hard bounces after an ISP outage](delivery/using/update-bounces.md)
          + [iOS certificate update](technotes/using/ios-certificate-update.md)
          + {hide-from-toc} [Tracked URLs update](technotes/using/tracked-urls.md)
     ...
     + [GCM based functions](technotes/using/gcm-functions.md)
