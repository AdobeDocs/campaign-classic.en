...
+ Get Started {#getting-started}
  ...
  + Profile management {#profile-management}
       ...
       + [Export and import profiles](platform/using/exporting-and-importing-profiles.md)
  ...
  + Administration basics {#administration-basics}
       ...
       + [Work with data packages](platform/using/working-with-data-packages.md)
       + [Manage enumerations](platform/using/managing-enumerations.md)
...
+ Send Messages {#sending-messages}
  ...
  + Send emails {#sending-emails}
       ...
       + Send an email {#sending-an-email}
            + [Confirm email delivery](delivery/using/sending-messages.md)
  ...
  + A/B testing {#a-b-testing}
       ...
       + Use case {#use-case}
          ...
          + [Analyze results](delivery/using/a-b-testing-uc-analyzing.md)
  ...
  + Track messages {#tracking-messages}
       ...
       + [Personalize URL tracking](delivery/using/personalizing-url-tracking.md)
       + [Access tracking logs](delivery/using/accessing-the-tracking-logs.md)
...
+ Orchestrate Campaigns {#orchestrating-campaigns}
  ...
  + Orchestrate campaigns {#orchestrate-campaigns}
       ...
       + [Use marketing campaign templates](campaign/using/marketing-campaign-templates.md)
       + [Send marketing campaign deliveries](campaign/using/marketing-campaign-deliveries.md)
       + [Set up marketing campaign approvals](campaign/using/marketing-campaign-approval.md)
       + [Monitor marketing campaigns](campaign/using/marketing-campaign-monitoring.md)
  ...
  + Distributed Marketing {#distributed-marketing}
       ...
       + [Distributed marketing samples](campaign/using/examples.md)
...
+ Reporting {#reporting}
  + Reporting capabilities{#reporting-in-adobe-campaign}
  ...
  + Analyze populations {#analyzing-populations}
       ...
       + [Process a report](reporting/using/processing-a-report.md)
  ...
  + Create new reports {#creating-new-reports}
       ...
       + [Design a new report](reporting/using/creating-a-new-report.md)
...
+ Design web content {#designing-content}
  ...
  + Edit HTML content {#editing-html-content}
       ...
       + [Content edition best practices](web/using/content-editing-best-practices.md)
  ...
  + Web forms {#web-forms}
       ...
       + [Define web form layout](web/using/defining-web-forms-layout.md)
       + [Form rendering](web/using/form-rendering.md)
       + [Define web form page sequencing](web/using/defining-web-forms-page-sequencing.md)
  ...
  + Online surveys {#online-surveys}
       ...
       + [Use case: create a Refer A Friend form](web/using/use-case--creating-a-refer-a-friend-form.md)
+ Integrate with Adobe Experience Cloud {#integrating-with-adobe-experience-cloud}
  ...
  + Experience Cloud Triggers {#experience-triggers}
       ...
       + [Configure Adobe I/O for Adobe Experience Cloud Triggers](integrations/using/configuring-adobe-io.md)
...
+ Automate with Workflows {#automating-with-workflows}
  ...
  + Advanced management {#advanced-management}
       ...
       + [Manage rights](workflow/using/managing-rights.md)
...
+ Manage Offers {#managing-offers}
  ...
  + Simulate offers {#simulating-offers}
...
+ Transactional Messaging {#transactional-messaging}
  ...
  + Event processing {#event-processing}
       ...
       + [Route towards a template](message-center/using/routing-towards-a-template.md)
...
+ Integrate with Social media {#integrating-with-social-media}
  ...
  + Publish on Facebook/Twitter {#publishing-on-facebook-twitter}
...
+ Developers guide {#configuring-campaign-classic}
  ...
  + Edit schemas {#editing-schemas}
       ...
       + [Extend a schema](configuration/using/extending-a-schema.md)
       + [Filter schemas](configuration/using/filtering-schemas.md)
       + [Restrict PII view](configuration/using/restricting-pii-view.md)
       ...
       + [Regenerate schemas](configuration/using/regenerating-schemas.md)
  ...
  + API {#api}
       ...
       + [Implement SOAP methods](configuration/using/implementing-soap-methods.md)
       + [SOAP methods in JavaScript](configuration/using/soap-methods-in-javascript.md)
       + [Add additional SQL functions](configuration/using/adding-additional-sql-functions.md)
  ...
  + Use a custom recipient table {#use-a-custom-recipient-table}
       ...
       + [Configure the interface](configuration/using/configuring-the-interface.md)
       + [Seed addresses](configuration/using/seed-addresses.md)
       + [Create predefined filters](configuration/using/creating-predefined-filters.md)
       + [Create a profile list with a workflow](configuration/using/creating-a-profile-list-with-a-workflow.md)
       + [Manage workflows](configuration/using/managing-workflows.md)
       + [Manage reports](configuration/using/managing-reports.md)
  + Setting up web tracking {#setting-up-web-tracking}
       ...
       + [Collect all visits](configuration/using/collecting-all-visits.md)
...
+ Migration guide {#migrating-to-a-new-version}
  ...
  + Migrating to Adobe Campaign 7 {#migrating-to-adobe-campaign-7}
       ...
       + [Campaign on Linux migration](migration/using/migrating-in-linux-for-adobe-campaign-v7.md)
  + Configuration {#configuration}
