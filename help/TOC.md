...
+ Release Notes {#release-notes}
  ...
  + [Technotes](technotes/using/using/technote.md)
  + [iOS certificate update](technotes/using/using/ios-certificate-update.md)
  + [Campaign configuration updates](technotes/using/using/acc-config-updates.md)
  + [Tracked URLs update](technotes/using/using/tracked-urls.md)
  + [IMS updates](technotes/using/using/ims-updates.md)
+ Get started {#getting-started}
  ...
  + Connectors {#connectors}
       ...
       + Adobe Analytics Connector{#analytics-connector}
          ...
          + [How to migrate to Adobe Analytics Connector](technotes/using/using/aa-connector-migration.md)
