...
+ Installation and configuration guide {#installing-campaign-classic}
  + Architecture and deployment {#architecture-and-hosting-models}
  ...
  + Install Campaign (on-premise)
       ...
       + Install Campaign on Windows {#installing-campaign-in-windows-}
          ...
          + [Integrate into a Web server](installation/using/integration-into-a-web-server-for-windows.md)
          + [Client console availability](installation/using/client-console-availability-for-windows.md)
       + Install Campaign on Linux  {#installing-campaign-in-linux-}
          + [Before installing Campaign on Linux](installation/using/prerequisites-of-campaign-installation-in-linux.md)
          + [Install packages with Linux](installation/using/installing-packages-with-linux.md)
  ...
  + Configure Campaign (on-premise) {#initial-configuration}
       ...
       + [Configure security zones](installation/using/security-zones.md)
       + [Technical email configurations](installation/using/email-deliverability.md)
       + [Configure Email BCC](installation/using/email-bcc.md)
